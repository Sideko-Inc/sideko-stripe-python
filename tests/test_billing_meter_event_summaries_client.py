...
def test_list_200_generated_success():
    """Tests a GET request to the /v1/billing/meters/{id}/event_summaries endpoint.
    ...
    Response : models.BillingMeterEventSummariesListResponse
    ...
    response = client.billing.meter.event_summaries.list(
...
async def test_await_list_200_generated_success():
    ...
    response = await client.billing.meter.event_summaries.list(
        customer="string", end_time=123, id="string", start_time=123
    )
    try:
        pydantic.TypeAdapter(
