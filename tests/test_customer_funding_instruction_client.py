...
def test_create_200_success_default():
    """Tests a POST request to the /v1/customers/{customer}/funding_instructions endpoint.
    ...
    Response : models.FundingInstructions
    ...
    try:
        pydantic.TypeAdapter(models.FundingInstructions).validate_python(response)
        is_json = True
