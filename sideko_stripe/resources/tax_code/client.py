...
class AsyncTaxCodeClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.tax_code.get(id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(expand, type_utils.NotGiven):
