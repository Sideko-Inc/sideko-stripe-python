...
class BalanceTransactionClient:
    ...
    def list(
        ...
        *,
        created: typing.Union[
            typing.Optional[
                typing.Union[params.BalanceTransactionListCreatedObj0, int]
            ],
            type_utils.NotGiven,
    ...
    ) -> models.BalanceTransactionListResponse:
        """
        ...
        Examples:
        ```py
        client.balance_transaction.list()
        ```
        """
        models.BalanceTransactionListResponse.model_rebuild(
            ...
            encode_query_param(
                ...
                to_encodable(
                    ...
                    dump_with=typing.Union[
                        params._SerializerBalanceTransactionListCreatedObj0, int
                    ],
                ),
                style="deepObject",
                explode=True,
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.balance_transaction.get(id="string")
        ```
        """
...
class AsyncBalanceTransactionClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.balance_transaction.list()
        ```
        """
        models.BalanceTransactionListResponse.model_rebuild(
            _types_namespace=models._types_namespace
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.balance_transaction.get(id="string")
        ```
        """
        models.BalanceTransaction.model_rebuild(
            _types_namespace=models._types_namespace
