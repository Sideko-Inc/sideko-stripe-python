...
from sideko_stripe.resources.application_fee.refund import (
    AsyncRefundClient,
    RefundClient,
)
...
class ApplicationFeeClient:
    ...
    def list(
        ...
        *,
        ...
        created: typing.Union[
            typing.Optional[typing.Union[params.ApplicationFeeListCreatedObj0, int]],
            type_utils.NotGiven,
        ] = type_utils.NOT_GIVEN,
    ...
    ) -> models.ApplicationFeeListResponse:
        """
        ...
        Examples:
        ```py
        client.application_fee.list()
        ```
        """
        models.ApplicationFeeListResponse.model_rebuild(
            ...
            encode_query_param(
                ...
                to_encodable(
                    ...
                    dump_with=typing.Union[
                        params._SerializerApplicationFeeListCreatedObj0, int
                    ],
                ),
                style="deepObject",
                explode=True,
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.application_fee.get(id="string")
        ```
        """
...
class AsyncApplicationFeeClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.application_fee.list()
        ```
        """
        models.ApplicationFeeListResponse.model_rebuild(
            _types_namespace=models._types_namespace
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.application_fee.get(id="string")
        ```
        """
        models.ApplicationFee.model_rebuild(_types_namespace=models._types_namespace)
        _query: QueryParams = {}
