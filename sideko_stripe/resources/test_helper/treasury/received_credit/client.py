...
class ReceivedCreditClient:
    ...
    def create(
        ...
        *,
        ...
        network: typing_extensions.Literal["ach", "us_domestic_wire"],
        ...
        initiating_payment_method_details: typing.Union[
            typing.Optional[
                params.TestHelperTreasuryReceivedCreditCreateBodyInitiatingPaymentMethodDetails
            ],
            type_utils.NotGiven,
        ] = type_utils.NOT_GIVEN,
        ...
        Examples:
        ```py
        client.test_helper.treasury.received_credit.create(
        ...
        _data = to_form_urlencoded(
            ...
            dump_with=params._SerializerTestHelperTreasuryReceivedCreditCreateBody,
            style={
                "amount": "form",
                "currency": "form",
                "description": "form",
...
class AsyncReceivedCreditClient:
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.test_helper.treasury.received_credit.create(
            amount=123, currency="string", financial_account="string", network="ach"
        )
        ```
        """
