...
class ActiveEntitlementClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.entitlement.active_entitlement.list(customer="string")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
    ...
    def get(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.EntitlementsActiveEntitlement:
        """
        ...
        Examples:
        ```py
        client.entitlement.active_entitlement.get(id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(expand, type_utils.NotGiven):
...
class AsyncActiveEntitlementClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.entitlement.active_entitlement.list(customer="string")
        ```
        """
        _query: QueryParams = {}
        encode_query_param(
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.entitlement.active_entitlement.get(id="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(expand, type_utils.NotGiven):
