...
class TokenClient:
    ...
    def list(
        ...
        *,
        ...
        created: typing.Union[
            typing.Optional[typing.Union[params.IssuingTokenListCreatedObj0, int]],
            type_utils.NotGiven,
        ...
        status: typing.Union[
            typing.Optional[
                typing_extensions.Literal["active", "deleted", "requested", "suspended"]
            ],
            type_utils.NotGiven,
        ] = type_utils.NOT_GIVEN,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.IssuingTokenListResponse:
        """
        ...
        ```
        """
        models.IssuingTokenListResponse.model_rebuild(
            ...
            encode_query_param(
                ...
                to_encodable(
                    ...
                    dump_with=typing.Union[
                        params._SerializerIssuingTokenListCreatedObj0, int
                    ],
                ),
                style="deepObject",
                explode=True,
            ...
            encode_query_param(
                ...
                to_encodable(
                    ...
                    dump_with=typing_extensions.Literal[
                        "active", "deleted", "requested", "suspended"
                    ],
                ),
                style="form",
                explode=True,
    ...
    def get(
        ...
        *,
        ...
        ```
        """
        models.IssuingToken.model_rebuild(_types_namespace=models._types_namespace)
        _query: QueryParams = {}
        if not isinstance(expand, type_utils.NotGiven):
            encode_query_param(
                _query,
    ...
    def update(
        ...
        *,
        ...
        _data = to_form_urlencoded(
            item={"expand": expand, "status": status},
            dump_with=params._SerializerIssuingTokenUpdateBody,
...
class AsyncTokenClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.issuing.token.list(card="string")
        ```
        """
        models.IssuingTokenListResponse.model_rebuild(
            _types_namespace=models._types_namespace
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.issuing.token.get(token="string")
        ```
        """
        models.IssuingToken.model_rebuild(_types_namespace=models._types_namespace)
        _query: QueryParams = {}
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.issuing.token.update(status="active", token="string")
        ```
        """
        models.IssuingToken.model_rebuild(_types_namespace=models._types_namespace)
        _data = to_form_urlencoded(
