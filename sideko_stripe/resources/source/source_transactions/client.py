...
class SourceTransactionsClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.source.source_transactions.list(source="string")
        ```
        """
        _query: QueryParams = {}
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.source.source_transactions.get(
...
class AsyncSourceTransactionsClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.source.source_transactions.list(source="string")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(ending_before, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.source.source_transactions.get(
            source="string", source_transaction="string"
        )
        ```
        """
