...
class CashBalanceTransactionClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.customer.cash_balance_transaction.list(customer="string")
        ```
        """
        models.CustomerCashBalanceTransactionListResponse.model_rebuild(
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/customers/{customer}/cash_balance_transactions",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.CustomerCashBalanceTransactionListResponse,
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.customer.cash_balance_transaction.get(
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/customers/{customer}/cash_balance_transactions/{transaction}",
            auth_names=["bearerAuth"],
            query_params=_query,
...
class AsyncCashBalanceTransactionClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.customer.cash_balance_transaction.list(customer="string")
        ```
        """
        models.CustomerCashBalanceTransactionListResponse.model_rebuild(
            _types_namespace=models._types_namespace
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.customer.cash_balance_transaction.get(
            customer="string", transaction="string"
        )
        ```
        """
