...
class DisputeClient:
    ...
    def list(
        ...
        *,
        ...
        created: typing.Union[
            typing.Optional[typing.Union[params.DisputeListCreatedObj0, int]],
            type_utils.NotGiven,
        ] = type_utils.NOT_GIVEN,
        ...
        ```
        """
        models.DisputeListResponse.model_rebuild(
            ...
            encode_query_param(
                ...
                to_encodable(
                    ...
                    dump_with=typing.Union[
                        params._SerializerDisputeListCreatedObj0, int
                    ],
                ),
                style="deepObject",
                explode=True,
    ...
    def update(
        ...
        *,
        dispute: str,
        data: typing.Union[
            typing.Optional[params.DisputeUpdateBody], type_utils.NotGiven
        ] = type_utils.NOT_GIVEN,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.Dispute:
        """
        ...
        _data = (
            to_form_urlencoded(
                item=data,
                dump_with=params._SerializerDisputeUpdateBody,
                style={
                    "evidence": "deepObject",
                    "expand": "deepObject",
                    "metadata": "deepObject",
    ...
    def close(
        ...
        *,
        dispute: str,
        data: typing.Union[
            typing.Optional[params.DisputeCloseBody], type_utils.NotGiven
        ] = type_utils.NOT_GIVEN,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.Dispute:
        """
        ...
        _data = (
            to_form_urlencoded(
                item=data,
                dump_with=params._SerializerDisputeCloseBody,
...
class AsyncDisputeClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.dispute.get(dispute="string")
        ```
        """
        models.Dispute.model_rebuild(_types_namespace=models._types_namespace)
        _query: QueryParams = {}
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.dispute.update(dispute="string")
        ```
        """
        models.Dispute.model_rebuild(_types_namespace=models._types_namespace)
        _data = (
    ...
    async def close(
        ...
        *,
        ...
        Examples:
        ```py
        await client.dispute.close(dispute="string")
        ```
        """
        models.Dispute.model_rebuild(_types_namespace=models._types_namespace)
        _data = (
