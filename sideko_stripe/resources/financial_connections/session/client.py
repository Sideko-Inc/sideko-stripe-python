...
class SessionClient:
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.financial_connections.session.get(session="string")
        ```
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/financial_connections/sessions/{session}",
    ...
    def create(
        self,
        *,
        account_holder: params.FinancialConnectionsSessionCreateBodyAccountHolder,
        ...
        filters: typing.Union[
            typing.Optional[params.FinancialConnectionsSessionCreateBodyFilters],
            type_utils.NotGiven,
        ] = type_utils.NOT_GIVEN,
        ...
        Examples:
        ```py
        client.financial_connections.session.create(
        ...
        _data = to_form_urlencoded(
            ...
            dump_with=params._SerializerFinancialConnectionsSessionCreateBody,
            style={
...
class AsyncSessionClient:
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.financial_connections.session.get(session="string")
        ```
        """
        models.FinancialConnectionsSession.model_rebuild(
            _types_namespace=models._types_namespace
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.financial_connections.session.create(
            account_holder={"type_": "account"}, permissions=["balances"]
        )
        ```
        """
