...
class LineItemClient:
    ...
    def list(
        ...
        *,
    ...
    ) -> models.PaymentLinksLineItemListResponse:
        """
        ...
        Examples:
        ```py
        client.payment_links.line_item.list(payment_link="string")
        ```
        """
        models.PaymentLinksLineItemListResponse.model_rebuild(
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v1/payment_links/{payment_link}/line_items",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.PaymentLinksLineItemListResponse,
...
class AsyncLineItemClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.payment_links.line_item.list(payment_link="string")
        ```
        """
        models.PaymentLinksLineItemListResponse.model_rebuild(
            _types_namespace=models._types_namespace
