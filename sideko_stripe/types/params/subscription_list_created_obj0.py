...
class SubscriptionListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionListCreatedObj0 handling case conversions
