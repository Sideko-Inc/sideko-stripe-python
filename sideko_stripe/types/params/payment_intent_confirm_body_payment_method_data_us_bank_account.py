...
class PaymentIntentConfirmBodyPaymentMethodDataUsBankAccount(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodDataUsBankAccount handling case conversions
