...
class SubscriptionCreateBodyTrialSettingsEndBehavior(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyTrialSettingsEndBehavior(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyTrialSettingsEndBehavior handling case conversions
