...
class CheckoutSessionListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCheckoutSessionListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for CheckoutSessionListCreatedObj0 handling case conversions
