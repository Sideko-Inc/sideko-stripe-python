...
class SetupIntentCreateBodyPaymentMethodOptionsAcssDebitMandateOptions(
...
class _SerializerSetupIntentCreateBodyPaymentMethodOptionsAcssDebitMandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentCreateBodyPaymentMethodOptionsAcssDebitMandateOptions handling case conversions
