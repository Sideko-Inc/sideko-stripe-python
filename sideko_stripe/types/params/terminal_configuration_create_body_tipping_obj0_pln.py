...
class TerminalConfigurationCreateBodyTippingObj0Pln(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Pln(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Pln handling case conversions
