...
class SetupIntentConfirmBodyPaymentMethodDataUsBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentConfirmBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodDataUsBankAccount handling case conversions
