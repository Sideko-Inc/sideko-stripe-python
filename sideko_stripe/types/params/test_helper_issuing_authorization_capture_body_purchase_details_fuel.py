...
class TestHelperIssuingAuthorizationCaptureBodyPurchaseDetailsFuel(
...
class _SerializerTestHelperIssuingAuthorizationCaptureBodyPurchaseDetailsFuel(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingAuthorizationCaptureBodyPurchaseDetailsFuel handling case conversions
