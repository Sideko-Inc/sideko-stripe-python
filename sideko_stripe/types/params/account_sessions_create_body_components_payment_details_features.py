...
class AccountSessionsCreateBodyComponentsPaymentDetailsFeatures(
...
class _SerializerAccountSessionsCreateBodyComponentsPaymentDetailsFeatures(
    pydantic.BaseModel
):
    """
    Serializer for AccountSessionsCreateBodyComponentsPaymentDetailsFeatures handling case conversions
