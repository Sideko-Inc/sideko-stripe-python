...
class PriceCreateBodyCurrencyOptionsAdditionalPropsTiersItem(
...
class _SerializerPriceCreateBodyCurrencyOptionsAdditionalPropsTiersItem(
    pydantic.BaseModel
):
    """
    Serializer for PriceCreateBodyCurrencyOptionsAdditionalPropsTiersItem handling case conversions
