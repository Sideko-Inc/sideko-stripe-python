...
class AccountPersonUpdateBodyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonUpdateBodyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountPersonUpdateBodyAddressKana handling case conversions
