...
class TerminalConfigurationUpdateBodyTippingObj0Eur(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Eur(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Eur handling case conversions
