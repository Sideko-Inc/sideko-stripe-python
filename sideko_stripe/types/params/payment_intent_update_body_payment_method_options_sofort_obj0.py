...
class PaymentIntentUpdateBodyPaymentMethodOptionsSofortObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsSofortObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsSofortObj0 handling case conversions
