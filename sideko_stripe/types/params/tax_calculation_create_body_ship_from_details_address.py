...
class TaxCalculationCreateBodyShipFromDetailsAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTaxCalculationCreateBodyShipFromDetailsAddress(pydantic.BaseModel):
    """
    Serializer for TaxCalculationCreateBodyShipFromDetailsAddress handling case conversions
