...
class PaymentIntentUpdateBodyPaymentMethodOptionsPaypalObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsPaypalObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsPaypalObj0 handling case conversions
