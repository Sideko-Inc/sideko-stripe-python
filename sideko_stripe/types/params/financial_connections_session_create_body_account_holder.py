...
class FinancialConnectionsSessionCreateBodyAccountHolder(typing_extensions.TypedDict):
    """
...
class _SerializerFinancialConnectionsSessionCreateBodyAccountHolder(pydantic.BaseModel):
    """
    Serializer for FinancialConnectionsSessionCreateBodyAccountHolder handling case conversions
