...
class PaymentMethodConfigurationUpdateBodySwishDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodySwishDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodySwishDisplayPreference handling case conversions
