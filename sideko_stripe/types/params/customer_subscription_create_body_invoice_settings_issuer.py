...
class CustomerSubscriptionCreateBodyInvoiceSettingsIssuer(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSubscriptionCreateBodyInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionCreateBodyInvoiceSettingsIssuer handling case conversions
