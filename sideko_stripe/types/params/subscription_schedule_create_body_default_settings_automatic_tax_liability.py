...
class SubscriptionScheduleCreateBodyDefaultSettingsAutomaticTaxLiability(
...
class _SerializerSubscriptionScheduleCreateBodyDefaultSettingsAutomaticTaxLiability(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleCreateBodyDefaultSettingsAutomaticTaxLiability handling case conversions
