...
class ChargeDisputeCreateBodyEvidence(typing_extensions.TypedDict):
    """
    ...
    enhanced_evidence: typing_extensions.NotRequired[
        typing.Union[ChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0, str]
    ]
...
class _SerializerChargeDisputeCreateBodyEvidence(pydantic.BaseModel):
    """
    Serializer for ChargeDisputeCreateBodyEvidence handling case conversions
    ...
    enhanced_evidence: typing.Optional[
        typing.Union[
            _SerializerChargeDisputeCreateBodyEvidenceEnhancedEvidenceObj0, str
        ]
