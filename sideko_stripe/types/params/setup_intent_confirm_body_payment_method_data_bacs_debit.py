...
class SetupIntentConfirmBodyPaymentMethodDataBacsDebit(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentConfirmBodyPaymentMethodDataBacsDebit(pydantic.BaseModel):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodDataBacsDebit handling case conversions
