...
class SubscriptionScheduleListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionScheduleListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionScheduleListCreatedObj0 handling case conversions
