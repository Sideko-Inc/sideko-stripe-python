...
class CustomerBankAccountCreateBodyCardObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerBankAccountCreateBodyCardObj0(pydantic.BaseModel):
    """
    Serializer for CustomerBankAccountCreateBodyCardObj0 handling case conversions
