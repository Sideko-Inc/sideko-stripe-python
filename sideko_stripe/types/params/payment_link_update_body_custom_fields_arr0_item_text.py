...
class PaymentLinkUpdateBodyCustomFieldsArr0ItemText(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentLinkUpdateBodyCustomFieldsArr0ItemText(pydantic.BaseModel):
    """
    Serializer for PaymentLinkUpdateBodyCustomFieldsArr0ItemText handling case conversions
