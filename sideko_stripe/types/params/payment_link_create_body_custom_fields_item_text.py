...
class PaymentLinkCreateBodyCustomFieldsItemText(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentLinkCreateBodyCustomFieldsItemText(pydantic.BaseModel):
    """
    Serializer for PaymentLinkCreateBodyCustomFieldsItemText handling case conversions
