...
class PaymentIntentCreateBodyPaymentMethodOptionsKakaoPayObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsKakaoPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsKakaoPayObj0 handling case conversions
