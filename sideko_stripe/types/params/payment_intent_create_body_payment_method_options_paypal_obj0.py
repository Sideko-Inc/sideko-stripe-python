...
class PaymentIntentCreateBodyPaymentMethodOptionsPaypalObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsPaypalObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsPaypalObj0 handling case conversions
