...
class TreasuryFinancialAccountListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryFinancialAccountListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TreasuryFinancialAccountListCreatedObj0 handling case conversions
