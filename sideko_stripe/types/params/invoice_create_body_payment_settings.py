...
class InvoiceCreateBodyPaymentSettings(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceCreateBodyPaymentSettings(pydantic.BaseModel):
    """
    Serializer for InvoiceCreateBodyPaymentSettings handling case conversions
