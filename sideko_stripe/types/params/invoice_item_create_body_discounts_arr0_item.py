...
class InvoiceItemCreateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceItemCreateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for InvoiceItemCreateBodyDiscountsArr0Item handling case conversions
