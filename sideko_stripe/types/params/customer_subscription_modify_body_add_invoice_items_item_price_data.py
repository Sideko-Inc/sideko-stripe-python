...
class CustomerSubscriptionModifyBodyAddInvoiceItemsItemPriceData(
...
class _SerializerCustomerSubscriptionModifyBodyAddInvoiceItemsItemPriceData(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionModifyBodyAddInvoiceItemsItemPriceData handling case conversions
