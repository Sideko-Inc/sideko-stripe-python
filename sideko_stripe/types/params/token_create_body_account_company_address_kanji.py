...
class TokenCreateBodyAccountCompanyAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountCompanyAddressKanji(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountCompanyAddressKanji handling case conversions
