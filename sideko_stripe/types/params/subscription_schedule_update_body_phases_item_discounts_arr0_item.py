...
class SubscriptionScheduleUpdateBodyPhasesItemDiscountsArr0Item(
...
class _SerializerSubscriptionScheduleUpdateBodyPhasesItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyPhasesItemDiscountsArr0Item handling case conversions
