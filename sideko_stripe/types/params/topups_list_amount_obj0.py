...
class TopupsListAmountObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTopupsListAmountObj0(pydantic.BaseModel):
    """
    Serializer for TopupsListAmountObj0 handling case conversions
