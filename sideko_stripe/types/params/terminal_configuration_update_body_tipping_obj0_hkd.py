...
class TerminalConfigurationUpdateBodyTippingObj0Hkd(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Hkd(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Hkd handling case conversions
