...
class QuoteUpdateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerQuoteUpdateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for QuoteUpdateBodyDiscountsArr0Item handling case conversions
