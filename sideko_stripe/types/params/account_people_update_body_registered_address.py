...
class AccountPeopleUpdateBodyRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyRegisteredAddress handling case conversions
