...
class IssuingCardCreateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingCardCreateBodyShippingAddress(pydantic.BaseModel):
    """
    Serializer for IssuingCardCreateBodyShippingAddress handling case conversions
