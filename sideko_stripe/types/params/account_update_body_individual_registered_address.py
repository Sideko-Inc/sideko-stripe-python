...
class AccountUpdateBodyIndividualRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyIndividualRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyIndividualRegisteredAddress handling case conversions
