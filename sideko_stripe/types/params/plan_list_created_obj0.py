...
class PlanListCreatedObj0(typing_extensions.TypedDict):
    """
    PlanListCreatedObj0
    """
...
class _SerializerPlanListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for PlanListCreatedObj0 handling case conversions
