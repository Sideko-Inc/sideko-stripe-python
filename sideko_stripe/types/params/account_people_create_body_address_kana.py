...
class AccountPeopleCreateBodyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyAddressKana handling case conversions
