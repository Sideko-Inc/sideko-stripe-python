...
class PaymentMethodConfigurationCreateBodySwishDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodySwishDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodySwishDisplayPreference handling case conversions
