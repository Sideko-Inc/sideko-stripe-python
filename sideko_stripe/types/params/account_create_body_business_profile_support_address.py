...
class AccountCreateBodyBusinessProfileSupportAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyBusinessProfileSupportAddress(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyBusinessProfileSupportAddress handling case conversions
