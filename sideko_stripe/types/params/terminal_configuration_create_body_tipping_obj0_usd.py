...
class TerminalConfigurationCreateBodyTippingObj0Usd(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Usd(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Usd handling case conversions
