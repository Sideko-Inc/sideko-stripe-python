...
class SetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecure(
...
class _SerializerSetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecure(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecure handling case conversions
