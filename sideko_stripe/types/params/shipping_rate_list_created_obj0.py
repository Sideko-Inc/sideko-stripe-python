...
class ShippingRateListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerShippingRateListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ShippingRateListCreatedObj0 handling case conversions
