...
class InvoicePreviewBodyInvoiceItemsItemPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyInvoiceItemsItemPriceData(pydantic.BaseModel):
    """
    Serializer for InvoicePreviewBodyInvoiceItemsItemPriceData handling case conversions
