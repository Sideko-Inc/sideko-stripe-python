...
class InvoiceUpdateBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceUpdateBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for InvoiceUpdateBodyAutomaticTaxLiability handling case conversions
