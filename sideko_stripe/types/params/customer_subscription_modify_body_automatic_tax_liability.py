...
class CustomerSubscriptionModifyBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSubscriptionModifyBodyAutomaticTaxLiability(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionModifyBodyAutomaticTaxLiability handling case conversions
