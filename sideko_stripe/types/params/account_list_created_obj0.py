...
class AccountListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerAccountListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for AccountListCreatedObj0 handling case conversions
