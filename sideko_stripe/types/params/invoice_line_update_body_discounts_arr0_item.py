...
class InvoiceLineUpdateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceLineUpdateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for InvoiceLineUpdateBodyDiscountsArr0Item handling case conversions
