...
class AppsSecretDeleteBodyScope(typing_extensions.TypedDict):
    """
...
class _SerializerAppsSecretDeleteBodyScope(pydantic.BaseModel):
    """
    Serializer for AppsSecretDeleteBodyScope handling case conversions
