...
class PaymentMethodConfigurationUpdateBodyP24DisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyP24DisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyP24DisplayPreference handling case conversions
