...
class PaymentIntentUpdateBodyPaymentMethodOptionsBacsDebitObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsBacsDebitObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsBacsDebitObj0 handling case conversions
