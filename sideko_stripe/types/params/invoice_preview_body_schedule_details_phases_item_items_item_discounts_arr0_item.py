...
class InvoicePreviewBodyScheduleDetailsPhasesItemItemsItemDiscountsArr0Item(
...
class _SerializerInvoicePreviewBodyScheduleDetailsPhasesItemItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyScheduleDetailsPhasesItemItemsItemDiscountsArr0Item handling case conversions
