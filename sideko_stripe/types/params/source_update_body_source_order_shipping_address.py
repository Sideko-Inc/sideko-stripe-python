...
class SourceUpdateBodySourceOrderShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerSourceUpdateBodySourceOrderShippingAddress(pydantic.BaseModel):
    """
    Serializer for SourceUpdateBodySourceOrderShippingAddress handling case conversions
