...
class CheckoutSessionCreateBodyPaymentMethodOptionsPaypal(typing_extensions.TypedDict):
    """
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsPaypal(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsPaypal handling case conversions
