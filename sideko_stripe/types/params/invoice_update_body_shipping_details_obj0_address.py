...
class InvoiceUpdateBodyShippingDetailsObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceUpdateBodyShippingDetailsObj0Address(pydantic.BaseModel):
    """
    Serializer for InvoiceUpdateBodyShippingDetailsObj0Address handling case conversions
