...
class AccountPersonUpdateBodyVerificationAdditionalDocument(
...
class _SerializerAccountPersonUpdateBodyVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for AccountPersonUpdateBodyVerificationAdditionalDocument handling case conversions
