...
class AccountExternalAccountCreateBodyBankAccountObj0(typing_extensions.TypedDict):
    """
...
class _SerializerAccountExternalAccountCreateBodyBankAccountObj0(pydantic.BaseModel):
    """
    Serializer for AccountExternalAccountCreateBodyBankAccountObj0 handling case conversions
