...
class AccountUpdateBodyIndividualAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyIndividualAddress(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyIndividualAddress handling case conversions
