...
class CustomerSubscriptionCreateBodyPaymentSettings(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSubscriptionCreateBodyPaymentSettings(pydantic.BaseModel):
    """
    Serializer for CustomerSubscriptionCreateBodyPaymentSettings handling case conversions
