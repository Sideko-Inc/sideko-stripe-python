...
class PaymentMethodConfigurationUpdateBodyGiropayDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyGiropayDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyGiropayDisplayPreference handling case conversions
