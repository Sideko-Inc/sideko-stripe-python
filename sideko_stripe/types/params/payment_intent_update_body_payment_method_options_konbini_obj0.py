...
class PaymentIntentUpdateBodyPaymentMethodOptionsKonbiniObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsKonbiniObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsKonbiniObj0 handling case conversions
