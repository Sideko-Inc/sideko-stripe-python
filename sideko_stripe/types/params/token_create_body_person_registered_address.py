...
class TokenCreateBodyPersonRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyPersonRegisteredAddress handling case conversions
