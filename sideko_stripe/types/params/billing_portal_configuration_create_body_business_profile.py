...
class BillingPortalConfigurationCreateBodyBusinessProfile(typing_extensions.TypedDict):
    """
...
class _SerializerBillingPortalConfigurationCreateBodyBusinessProfile(
    pydantic.BaseModel
):
    """
    Serializer for BillingPortalConfigurationCreateBodyBusinessProfile handling case conversions
