...
class CustomerSourceUpdateBodyOwnerAddress(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSourceUpdateBodyOwnerAddress(pydantic.BaseModel):
    """
    Serializer for CustomerSourceUpdateBodyOwnerAddress handling case conversions
