...
class SubscriptionCreateBodyPaymentSettingsPaymentMethodOptionsCardObj0MandateOptions(
...
class _SerializerSubscriptionCreateBodyPaymentSettingsPaymentMethodOptionsCardObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionCreateBodyPaymentSettingsPaymentMethodOptionsCardObj0MandateOptions handling case conversions
