...
class PaymentMethodConfigurationUpdateBodyPaynowDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyPaynowDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyPaynowDisplayPreference handling case conversions
