...
class SubscriptionListCurrentPeriodEndObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionListCurrentPeriodEndObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionListCurrentPeriodEndObj0 handling case conversions
