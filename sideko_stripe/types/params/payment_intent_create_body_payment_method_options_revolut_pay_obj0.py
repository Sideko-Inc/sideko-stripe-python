...
class PaymentIntentCreateBodyPaymentMethodOptionsRevolutPayObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsRevolutPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsRevolutPayObj0 handling case conversions
