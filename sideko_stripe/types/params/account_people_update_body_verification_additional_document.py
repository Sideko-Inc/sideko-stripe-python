...
class AccountPeopleUpdateBodyVerificationAdditionalDocument(
...
class _SerializerAccountPeopleUpdateBodyVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for AccountPeopleUpdateBodyVerificationAdditionalDocument handling case conversions
