...
class LinkedAccountRefreshBody(typing_extensions.TypedDict, total=False):
    """
...
class _SerializerLinkedAccountRefreshBody(pydantic.BaseModel):
    """
    Serializer for LinkedAccountRefreshBody handling case conversions
