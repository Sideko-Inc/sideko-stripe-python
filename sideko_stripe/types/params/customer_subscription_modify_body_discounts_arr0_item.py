...
class CustomerSubscriptionModifyBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSubscriptionModifyBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for CustomerSubscriptionModifyBodyDiscountsArr0Item handling case conversions
