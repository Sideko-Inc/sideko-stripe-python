...
class AccountCreateBodyCompanyDirectorshipDeclaration(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyCompanyDirectorshipDeclaration(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyCompanyDirectorshipDeclaration handling case conversions
