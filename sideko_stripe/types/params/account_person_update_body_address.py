...
class AccountPersonUpdateBodyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonUpdateBodyAddress(pydantic.BaseModel):
    """
    Serializer for AccountPersonUpdateBodyAddress handling case conversions
