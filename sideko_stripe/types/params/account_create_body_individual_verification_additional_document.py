...
class AccountCreateBodyIndividualVerificationAdditionalDocument(
...
class _SerializerAccountCreateBodyIndividualVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for AccountCreateBodyIndividualVerificationAdditionalDocument handling case conversions
