...
class SubscriptionScheduleListCanceledAtObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionScheduleListCanceledAtObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionScheduleListCanceledAtObj0 handling case conversions
