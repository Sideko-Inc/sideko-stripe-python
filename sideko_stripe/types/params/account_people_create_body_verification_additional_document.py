...
class AccountPeopleCreateBodyVerificationAdditionalDocument(
...
class _SerializerAccountPeopleCreateBodyVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for AccountPeopleCreateBodyVerificationAdditionalDocument handling case conversions
