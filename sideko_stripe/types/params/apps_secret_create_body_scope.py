...
class AppsSecretCreateBodyScope(typing_extensions.TypedDict):
    """
...
class _SerializerAppsSecretCreateBodyScope(pydantic.BaseModel):
    """
    Serializer for AppsSecretCreateBodyScope handling case conversions
