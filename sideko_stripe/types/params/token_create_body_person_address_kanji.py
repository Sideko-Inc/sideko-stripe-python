...
class TokenCreateBodyPersonAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonAddressKanji(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyPersonAddressKanji handling case conversions
