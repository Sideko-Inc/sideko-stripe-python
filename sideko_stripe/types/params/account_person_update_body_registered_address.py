...
class AccountPersonUpdateBodyRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonUpdateBodyRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountPersonUpdateBodyRegisteredAddress handling case conversions
