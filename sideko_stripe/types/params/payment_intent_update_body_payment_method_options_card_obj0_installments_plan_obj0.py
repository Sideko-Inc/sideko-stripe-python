...
class PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0 handling case conversions
