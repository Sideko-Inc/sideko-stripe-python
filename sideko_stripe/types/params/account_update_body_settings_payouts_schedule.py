...
class AccountUpdateBodySettingsPayoutsSchedule(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodySettingsPayoutsSchedule(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodySettingsPayoutsSchedule handling case conversions
