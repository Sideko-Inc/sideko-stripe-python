...
class PaymentIntentConfirmBodyPaymentMethodOptionsBoletoObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsBoletoObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsBoletoObj0 handling case conversions
