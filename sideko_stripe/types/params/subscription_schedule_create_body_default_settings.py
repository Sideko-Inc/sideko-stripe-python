...
class SubscriptionScheduleCreateBodyDefaultSettings(typing_extensions.TypedDict):
    """
    ...
    transfer_data: typing_extensions.NotRequired[
        typing.Union[SubscriptionScheduleCreateBodyDefaultSettingsTransferDataObj0, str]
    ]


class _SerializerSubscriptionScheduleCreateBodyDefaultSettings(pydantic.BaseModel):
    """
    Serializer for SubscriptionScheduleCreateBodyDefaultSettings handling case conversions
