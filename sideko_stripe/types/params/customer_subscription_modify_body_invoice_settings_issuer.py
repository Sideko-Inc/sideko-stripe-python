...
class CustomerSubscriptionModifyBodyInvoiceSettingsIssuer(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSubscriptionModifyBodyInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionModifyBodyInvoiceSettingsIssuer handling case conversions
