...
class TopupsListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTopupsListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TopupsListCreatedObj0 handling case conversions
