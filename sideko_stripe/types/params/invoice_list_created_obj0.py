...
class InvoiceListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for InvoiceListCreatedObj0 handling case conversions
