...
class PaymentIntentCreateBodyPaymentMethodOptionsAffirmObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsAffirmObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsAffirmObj0 handling case conversions
