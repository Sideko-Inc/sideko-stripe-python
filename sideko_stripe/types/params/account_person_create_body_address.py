...
class AccountPersonCreateBodyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonCreateBodyAddress(pydantic.BaseModel):
    """
    Serializer for AccountPersonCreateBodyAddress handling case conversions
