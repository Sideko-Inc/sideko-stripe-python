...
class IssuingCardholderUpdateBodyIndividualVerificationDocument(
...
class _SerializerIssuingCardholderUpdateBodyIndividualVerificationDocument(
    pydantic.BaseModel
):
    """
    Serializer for IssuingCardholderUpdateBodyIndividualVerificationDocument handling case conversions
