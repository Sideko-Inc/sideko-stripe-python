...
class TokenCreateBodyAccountIndividualAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountIndividualAddressKana(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountIndividualAddressKana handling case conversions
