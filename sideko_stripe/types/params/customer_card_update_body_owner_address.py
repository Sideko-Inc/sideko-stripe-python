...
class CustomerCardUpdateBodyOwnerAddress(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerCardUpdateBodyOwnerAddress(pydantic.BaseModel):
    """
    Serializer for CustomerCardUpdateBodyOwnerAddress handling case conversions
