...
class AccountCreateBodySettingsCardIssuingTosAcceptance(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodySettingsCardIssuingTosAcceptance(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodySettingsCardIssuingTosAcceptance handling case conversions
