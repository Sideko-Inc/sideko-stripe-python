...
class TreasuryOutboundPaymentListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryOutboundPaymentListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TreasuryOutboundPaymentListCreatedObj0 handling case conversions
