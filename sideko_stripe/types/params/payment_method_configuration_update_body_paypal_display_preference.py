...
class PaymentMethodConfigurationUpdateBodyPaypalDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyPaypalDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyPaypalDisplayPreference handling case conversions
