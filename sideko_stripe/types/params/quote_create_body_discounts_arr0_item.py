...
class QuoteCreateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerQuoteCreateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for QuoteCreateBodyDiscountsArr0Item handling case conversions
