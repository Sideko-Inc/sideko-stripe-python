...
class TreasuryTransactionEntryListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryTransactionEntryListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TreasuryTransactionEntryListCreatedObj0 handling case conversions
