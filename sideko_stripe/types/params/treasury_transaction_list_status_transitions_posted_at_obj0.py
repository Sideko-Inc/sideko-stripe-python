...
class TreasuryTransactionListStatusTransitionsPostedAtObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryTransactionListStatusTransitionsPostedAtObj0(
    pydantic.BaseModel
):
    """
    Serializer for TreasuryTransactionListStatusTransitionsPostedAtObj0 handling case conversions
