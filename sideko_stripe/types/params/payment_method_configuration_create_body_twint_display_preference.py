...
class PaymentMethodConfigurationCreateBodyTwintDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyTwintDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyTwintDisplayPreference handling case conversions
