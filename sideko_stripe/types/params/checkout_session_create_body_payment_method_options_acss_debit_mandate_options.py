...
class CheckoutSessionCreateBodyPaymentMethodOptionsAcssDebitMandateOptions(
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsAcssDebitMandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsAcssDebitMandateOptions handling case conversions
