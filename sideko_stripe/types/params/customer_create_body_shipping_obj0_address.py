...
class CustomerCreateBodyShippingObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerCreateBodyShippingObj0Address(pydantic.BaseModel):
    """
    Serializer for CustomerCreateBodyShippingObj0Address handling case conversions
