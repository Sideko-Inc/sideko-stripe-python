...
class AccountPeopleUpdateBodyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyAddressKana handling case conversions
