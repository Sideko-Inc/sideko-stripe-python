...
class RadarValueListListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerRadarValueListListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for RadarValueListListCreatedObj0 handling case conversions
