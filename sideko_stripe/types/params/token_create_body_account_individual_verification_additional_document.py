...
class TokenCreateBodyAccountIndividualVerificationAdditionalDocument(
...
class _SerializerTokenCreateBodyAccountIndividualVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for TokenCreateBodyAccountIndividualVerificationAdditionalDocument handling case conversions
