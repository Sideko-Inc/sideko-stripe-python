...
class PaymentIntentCreateBodyPaymentMethodDataAcssDebit(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyPaymentMethodDataAcssDebit(pydantic.BaseModel):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodDataAcssDebit handling case conversions
