...
class PaymentMethodConfigurationUpdateBodySofortDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodySofortDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodySofortDisplayPreference handling case conversions
