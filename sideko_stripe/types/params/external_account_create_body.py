...
class ExternalAccountCreateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    documents: typing_extensions.NotRequired[ExternalAccountCreateBodyDocuments]
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[ExternalAccountCreateBodyMetadataObj0, str]
    ]
    """
...
class _SerializerExternalAccountCreateBody(pydantic.BaseModel):
    """
    Serializer for ExternalAccountCreateBody handling case conversions
    ...
    documents: typing.Optional[_SerializerExternalAccountCreateBodyDocuments] = (
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerExternalAccountCreateBodyMetadataObj0, str]
