...
class SubscriptionScheduleUpdateBodyPhasesItemItemsItemDiscountsArr0Item(
...
class _SerializerSubscriptionScheduleUpdateBodyPhasesItemItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyPhasesItemItemsItemDiscountsArr0Item handling case conversions
