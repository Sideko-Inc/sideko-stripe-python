...
class SubscriptionUpdateBodyAddInvoiceItemsItemPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionUpdateBodyAddInvoiceItemsItemPriceData(pydantic.BaseModel):
    """
    Serializer for SubscriptionUpdateBodyAddInvoiceItemsItemPriceData handling case conversions
