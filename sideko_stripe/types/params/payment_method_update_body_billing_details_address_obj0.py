...
class PaymentMethodUpdateBodyBillingDetailsAddressObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentMethodUpdateBodyBillingDetailsAddressObj0(pydantic.BaseModel):
    """
    Serializer for PaymentMethodUpdateBodyBillingDetailsAddressObj0 handling case conversions
