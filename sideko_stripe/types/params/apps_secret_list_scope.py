...
class AppsSecretListScope(typing_extensions.TypedDict):
    """
...
class _SerializerAppsSecretListScope(pydantic.BaseModel):
    """
    Serializer for AppsSecretListScope handling case conversions
