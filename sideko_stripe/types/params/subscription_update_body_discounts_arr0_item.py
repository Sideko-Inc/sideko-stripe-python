...
class SubscriptionUpdateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionUpdateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for SubscriptionUpdateBodyDiscountsArr0Item handling case conversions
