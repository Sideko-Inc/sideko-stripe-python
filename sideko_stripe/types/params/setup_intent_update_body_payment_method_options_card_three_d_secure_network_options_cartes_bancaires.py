...
class SetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires(
...
class _SerializerSetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodOptionsCardThreeDSecureNetworkOptionsCartesBancaires handling case conversions
