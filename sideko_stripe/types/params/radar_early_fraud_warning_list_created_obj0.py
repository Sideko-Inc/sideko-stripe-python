...
class RadarEarlyFraudWarningListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerRadarEarlyFraudWarningListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for RadarEarlyFraudWarningListCreatedObj0 handling case conversions
