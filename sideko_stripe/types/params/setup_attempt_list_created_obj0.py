...
class SetupAttemptListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSetupAttemptListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for SetupAttemptListCreatedObj0 handling case conversions
