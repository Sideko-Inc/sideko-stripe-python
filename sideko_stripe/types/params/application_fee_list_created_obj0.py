...
class ApplicationFeeListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerApplicationFeeListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ApplicationFeeListCreatedObj0 handling case conversions
