...
class PaymentMethodConfigurationUpdateBodyJcbDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyJcbDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyJcbDisplayPreference handling case conversions
