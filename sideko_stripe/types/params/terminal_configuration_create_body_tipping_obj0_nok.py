...
class TerminalConfigurationCreateBodyTippingObj0Nok(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Nok(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Nok handling case conversions
