...
class TokenCreateBodyPersonAdditionalTosAcceptancesAccount(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonAdditionalTosAcceptancesAccount(
    pydantic.BaseModel
):
    """
    Serializer for TokenCreateBodyPersonAdditionalTosAcceptancesAccount handling case conversions
