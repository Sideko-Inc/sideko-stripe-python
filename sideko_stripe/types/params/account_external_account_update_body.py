...
class AccountExternalAccountUpdateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    documents: typing_extensions.NotRequired[AccountExternalAccountUpdateBodyDocuments]
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[AccountExternalAccountUpdateBodyMetadataObj0, str]
    ]
    """
...
class _SerializerAccountExternalAccountUpdateBody(pydantic.BaseModel):
    """
    Serializer for AccountExternalAccountUpdateBody handling case conversions
    ...
    documents: typing.Optional[_SerializerAccountExternalAccountUpdateBodyDocuments] = (
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerAccountExternalAccountUpdateBodyMetadataObj0, str]
