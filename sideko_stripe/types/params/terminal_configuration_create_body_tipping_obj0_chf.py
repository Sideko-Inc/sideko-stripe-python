...
class TerminalConfigurationCreateBodyTippingObj0Chf(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Chf(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Chf handling case conversions
