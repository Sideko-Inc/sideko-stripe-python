...
class CustomerListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for CustomerListCreatedObj0 handling case conversions
