...
class CustomerUpdateBodyAddressObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerUpdateBodyAddressObj0(pydantic.BaseModel):
    """
    Serializer for CustomerUpdateBodyAddressObj0 handling case conversions
