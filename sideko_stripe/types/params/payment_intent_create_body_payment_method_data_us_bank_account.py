...
class PaymentIntentCreateBodyPaymentMethodDataUsBankAccount(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodDataUsBankAccount handling case conversions
