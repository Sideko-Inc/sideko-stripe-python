...
class AccountPersonUpdateBodyAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonUpdateBodyAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountPersonUpdateBodyAddressKanji handling case conversions
