...
class InvoiceItemListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceItemListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for InvoiceItemListCreatedObj0 handling case conversions
