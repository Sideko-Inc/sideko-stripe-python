...
class IssuingDisputeUpdateBodyEvidenceMerchandiseNotAsDescribedObj0(
...
class _SerializerIssuingDisputeUpdateBodyEvidenceMerchandiseNotAsDescribedObj0(
    pydantic.BaseModel
):
    """
    Serializer for IssuingDisputeUpdateBodyEvidenceMerchandiseNotAsDescribedObj0 handling case conversions
