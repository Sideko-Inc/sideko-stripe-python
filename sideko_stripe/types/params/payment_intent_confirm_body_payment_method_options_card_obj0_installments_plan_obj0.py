...
class PaymentIntentConfirmBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0 handling case conversions
