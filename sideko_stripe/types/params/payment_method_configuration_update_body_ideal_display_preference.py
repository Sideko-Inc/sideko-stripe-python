...
class PaymentMethodConfigurationUpdateBodyIdealDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyIdealDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyIdealDisplayPreference handling case conversions
