...
class CustomerUpdateBodyShippingObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerUpdateBodyShippingObj0Address(pydantic.BaseModel):
    """
    Serializer for CustomerUpdateBodyShippingObj0Address handling case conversions
