...
class SubscriptionCreateBody(typing_extensions.TypedDict, total=False):
    """
    SubscriptionCreateBody
    """

    add_invoice_items: typing_extensions.NotRequired[
        typing.List[SubscriptionCreateBodyAddInvoiceItemsItem]
    ]
    """
    ...
    automatic_tax: typing_extensions.NotRequired[SubscriptionCreateBodyAutomaticTax]
    """
    ...
    billing_cycle_anchor_config: typing_extensions.NotRequired[
        SubscriptionCreateBodyBillingCycleAnchorConfig
    ]
    """
    ...
    discounts: typing_extensions.NotRequired[
        typing.Union[typing.List[SubscriptionCreateBodyDiscountsArr0Item], str]
    ]
    """
    ...
    items: typing_extensions.NotRequired[typing.List[SubscriptionCreateBodyItemsItem]]
    """
    A list of up to 20 subscription items, each with an attached price.
    """

    metadata: typing_extensions.NotRequired[
        typing.Union[SubscriptionCreateBodyMetadataObj0, str]
    ]
    """
    ...
    pending_invoice_item_interval: typing_extensions.NotRequired[
        typing.Union[SubscriptionCreateBodyPendingInvoiceItemIntervalObj0, str]
    ]
    """
    ...
    transfer_data: typing_extensions.NotRequired[SubscriptionCreateBodyTransferData]
    """
    ...
    trial_settings: typing_extensions.NotRequired[SubscriptionCreateBodyTrialSettings]
    """
    Settings related to subscription trials.
    """


class _SerializerSubscriptionCreateBody(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBody handling case conversions
    ...
    add_invoice_items: typing.Optional[
        typing.List[_SerializerSubscriptionCreateBodyAddInvoiceItemsItem]
    ...
    automatic_tax: typing.Optional[_SerializerSubscriptionCreateBodyAutomaticTax] = (
    ...
    discounts: typing.Optional[
        typing.Union[
            typing.List[_SerializerSubscriptionCreateBodyDiscountsArr0Item], str
        ]
    ...
    items: typing.Optional[typing.List[_SerializerSubscriptionCreateBodyItemsItem]] = (
        pydantic.Field(alias="items", default=None)
    )
    metadata: typing.Optional[
        typing.Union[_SerializerSubscriptionCreateBodyMetadataObj0, str]
    ...
    pending_invoice_item_interval: typing.Optional[
        typing.Union[
            _SerializerSubscriptionCreateBodyPendingInvoiceItemIntervalObj0, str
        ]
    ...
    transfer_data: typing.Optional[_SerializerSubscriptionCreateBodyTransferData] = (
    ...
    trial_settings: typing.Optional[_SerializerSubscriptionCreateBodyTrialSettings] = (
