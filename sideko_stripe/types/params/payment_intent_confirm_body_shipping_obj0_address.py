...
class PaymentIntentConfirmBodyShippingObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentConfirmBodyShippingObj0Address(pydantic.BaseModel):
    """
    Serializer for PaymentIntentConfirmBodyShippingObj0Address handling case conversions
