...
class SubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemDiscountsItem(
...
class _SerializerSubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemDiscountsItem(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemDiscountsItem handling case conversions
