...
class PaymentLinkCreateBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentLinkCreateBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for PaymentLinkCreateBodyAutomaticTaxLiability handling case conversions
