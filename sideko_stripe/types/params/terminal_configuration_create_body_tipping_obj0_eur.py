...
class TerminalConfigurationCreateBodyTippingObj0Eur(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Eur(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Eur handling case conversions
