...
class InvoicePreviewBodyInvoiceItemsItemDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyInvoiceItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyInvoiceItemsItemDiscountsArr0Item handling case conversions
