...
class InvoiceUpdateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceUpdateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for InvoiceUpdateBodyDiscountsArr0Item handling case conversions
