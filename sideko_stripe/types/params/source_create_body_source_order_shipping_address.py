...
class SourceCreateBodySourceOrderShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerSourceCreateBodySourceOrderShippingAddress(pydantic.BaseModel):
    """
    Serializer for SourceCreateBodySourceOrderShippingAddress handling case conversions
