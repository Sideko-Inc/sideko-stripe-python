...
class CustomerSourceCreateBodyBankAccountObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerSourceCreateBodyBankAccountObj0(pydantic.BaseModel):
    """
    Serializer for CustomerSourceCreateBodyBankAccountObj0 handling case conversions
