...
class PaymentIntentUpdateBodyPaymentMethodOptionsAuBecsDebitObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsAuBecsDebitObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsAuBecsDebitObj0 handling case conversions
