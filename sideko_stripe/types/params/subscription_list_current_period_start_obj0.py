...
class SubscriptionListCurrentPeriodStartObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionListCurrentPeriodStartObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionListCurrentPeriodStartObj0 handling case conversions
