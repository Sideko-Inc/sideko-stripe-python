...
class QuoteUpdateBodyLineItemsItemDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerQuoteUpdateBodyLineItemsItemDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for QuoteUpdateBodyLineItemsItemDiscountsArr0Item handling case conversions
