...
class CheckoutSessionCreateBodyPaymentMethodOptionsKakaoPay(
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsKakaoPay(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsKakaoPay handling case conversions
