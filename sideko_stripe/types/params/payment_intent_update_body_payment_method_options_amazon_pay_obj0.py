...
class PaymentIntentUpdateBodyPaymentMethodOptionsAmazonPayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsAmazonPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsAmazonPayObj0 handling case conversions
