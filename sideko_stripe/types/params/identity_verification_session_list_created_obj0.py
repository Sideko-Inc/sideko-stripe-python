...
class IdentityVerificationSessionListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIdentityVerificationSessionListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for IdentityVerificationSessionListCreatedObj0 handling case conversions
