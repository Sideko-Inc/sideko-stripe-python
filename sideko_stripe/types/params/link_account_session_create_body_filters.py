...
class LinkAccountSessionCreateBodyFilters(typing_extensions.TypedDict):
    """
...
class _SerializerLinkAccountSessionCreateBodyFilters(pydantic.BaseModel):
    """
    Serializer for LinkAccountSessionCreateBodyFilters handling case conversions
