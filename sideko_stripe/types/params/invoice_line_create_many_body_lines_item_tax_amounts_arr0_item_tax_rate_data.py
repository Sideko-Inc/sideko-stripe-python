...
class InvoiceLineCreateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData(
...
class _SerializerInvoiceLineCreateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData(
    pydantic.BaseModel
):
    """
    Serializer for InvoiceLineCreateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData handling case conversions
