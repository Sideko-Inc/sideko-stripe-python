...
class PaymentMethodConfigurationUpdateBodyZipDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyZipDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyZipDisplayPreference handling case conversions
