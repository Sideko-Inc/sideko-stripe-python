...
class IssuingCardListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingCardListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for IssuingCardListCreatedObj0 handling case conversions
