...
class CreditNoteListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCreditNoteListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for CreditNoteListCreatedObj0 handling case conversions
