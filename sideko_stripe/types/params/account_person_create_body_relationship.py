...
class AccountPersonCreateBodyRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonCreateBodyRelationship(pydantic.BaseModel):
    """
    Serializer for AccountPersonCreateBodyRelationship handling case conversions
