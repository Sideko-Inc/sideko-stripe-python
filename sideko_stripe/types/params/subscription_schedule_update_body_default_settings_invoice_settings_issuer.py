...
class SubscriptionScheduleUpdateBodyDefaultSettingsInvoiceSettingsIssuer(
...
class _SerializerSubscriptionScheduleUpdateBodyDefaultSettingsInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyDefaultSettingsInvoiceSettingsIssuer handling case conversions
