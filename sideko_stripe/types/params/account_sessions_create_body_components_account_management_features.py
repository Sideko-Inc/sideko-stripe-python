...
class AccountSessionsCreateBodyComponentsAccountManagementFeatures(
...
class _SerializerAccountSessionsCreateBodyComponentsAccountManagementFeatures(
    pydantic.BaseModel
):
    """
    Serializer for AccountSessionsCreateBodyComponentsAccountManagementFeatures handling case conversions
