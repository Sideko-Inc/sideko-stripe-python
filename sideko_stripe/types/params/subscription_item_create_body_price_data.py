...
class SubscriptionItemCreateBodyPriceData(typing_extensions.TypedDict):
    """
    ...
    recurring: typing_extensions.Required[SubscriptionItemCreateBodyPriceDataRecurring]
...
class _SerializerSubscriptionItemCreateBodyPriceData(pydantic.BaseModel):
    """
    Serializer for SubscriptionItemCreateBodyPriceData handling case conversions
    ...
    recurring: _SerializerSubscriptionItemCreateBodyPriceDataRecurring = pydantic.Field(
        alias="recurring",
    )
