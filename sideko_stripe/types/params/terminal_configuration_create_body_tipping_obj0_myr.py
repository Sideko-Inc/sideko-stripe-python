...
class TerminalConfigurationCreateBodyTippingObj0Myr(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Myr(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Myr handling case conversions
