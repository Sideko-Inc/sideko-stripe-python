...
class PaymentIntentListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for PaymentIntentListCreatedObj0 handling case conversions
