...
class AccountPersonCreateBodyRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonCreateBodyRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountPersonCreateBodyRegisteredAddress handling case conversions
