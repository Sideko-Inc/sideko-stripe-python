...
class AccountUpdateBodyCompanyAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyCompanyAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyCompanyAddressKanji handling case conversions
