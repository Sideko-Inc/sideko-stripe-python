...
class PaymentIntentUpdateBodyPaymentMethodOptionsAffirmObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsAffirmObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsAffirmObj0 handling case conversions
