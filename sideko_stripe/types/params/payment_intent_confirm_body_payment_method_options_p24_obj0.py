...
class PaymentIntentConfirmBodyPaymentMethodOptionsP24Obj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsP24Obj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsP24Obj0 handling case conversions
