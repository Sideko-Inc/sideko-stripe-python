...
class PaymentIntentConfirmBodyPaymentMethodOptionsCashappObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsCashappObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsCashappObj0 handling case conversions
