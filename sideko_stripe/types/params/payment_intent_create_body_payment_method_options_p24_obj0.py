...
class PaymentIntentCreateBodyPaymentMethodOptionsP24Obj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsP24Obj0(pydantic.BaseModel):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsP24Obj0 handling case conversions
