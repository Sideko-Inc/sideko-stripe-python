...
class ProductListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerProductListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ProductListCreatedObj0 handling case conversions
