...
class IssuingDisputeUpdateBodyEvidenceFraudulentObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingDisputeUpdateBodyEvidenceFraudulentObj0(pydantic.BaseModel):
    """
    Serializer for IssuingDisputeUpdateBodyEvidenceFraudulentObj0 handling case conversions
