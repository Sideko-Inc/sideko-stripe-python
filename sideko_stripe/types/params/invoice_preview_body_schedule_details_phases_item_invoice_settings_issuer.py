...
class InvoicePreviewBodyScheduleDetailsPhasesItemInvoiceSettingsIssuer(
...
class _SerializerInvoicePreviewBodyScheduleDetailsPhasesItemInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyScheduleDetailsPhasesItemInvoiceSettingsIssuer handling case conversions
