...
class CheckoutSessionCreateBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerCheckoutSessionCreateBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for CheckoutSessionCreateBodyAutomaticTaxLiability handling case conversions
