...
class TransferListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTransferListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TransferListCreatedObj0 handling case conversions
