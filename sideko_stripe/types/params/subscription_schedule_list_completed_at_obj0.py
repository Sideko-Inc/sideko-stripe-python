...
class SubscriptionScheduleListCompletedAtObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionScheduleListCompletedAtObj0(pydantic.BaseModel):
    """
    Serializer for SubscriptionScheduleListCompletedAtObj0 handling case conversions
