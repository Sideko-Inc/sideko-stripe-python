...
class PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0MandateOptions(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsCardObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0MandateOptions handling case conversions
