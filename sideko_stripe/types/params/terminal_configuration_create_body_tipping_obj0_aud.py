...
class TerminalConfigurationCreateBodyTippingObj0Aud(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Aud(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Aud handling case conversions
