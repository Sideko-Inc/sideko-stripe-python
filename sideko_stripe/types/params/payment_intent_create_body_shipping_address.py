...
class PaymentIntentCreateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyShippingAddress(pydantic.BaseModel):
    """
    Serializer for PaymentIntentCreateBodyShippingAddress handling case conversions
