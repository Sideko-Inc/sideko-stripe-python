...
class PaymentIntentCreateBodyPaymentMethodOptionsCashappObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsCashappObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsCashappObj0 handling case conversions
