...
class AccountUpdateBodyBusinessProfileSupportAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyBusinessProfileSupportAddress(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyBusinessProfileSupportAddress handling case conversions
