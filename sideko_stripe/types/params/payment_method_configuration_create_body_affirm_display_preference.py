...
class PaymentMethodConfigurationCreateBodyAffirmDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyAffirmDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyAffirmDisplayPreference handling case conversions
