...
class PaymentIntentUpdateBodyPaymentMethodOptionsMobilepayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsMobilepayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsMobilepayObj0 handling case conversions
