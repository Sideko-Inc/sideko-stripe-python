...
class AccountPeopleCreateBodyAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyAddressKanji handling case conversions
