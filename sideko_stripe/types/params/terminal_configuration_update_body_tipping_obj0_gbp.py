...
class TerminalConfigurationUpdateBodyTippingObj0Gbp(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Gbp(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Gbp handling case conversions
