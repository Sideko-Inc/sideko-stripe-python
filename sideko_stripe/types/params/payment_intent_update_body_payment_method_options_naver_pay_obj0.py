...
class PaymentIntentUpdateBodyPaymentMethodOptionsNaverPayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsNaverPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsNaverPayObj0 handling case conversions
