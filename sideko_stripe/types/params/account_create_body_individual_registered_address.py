...
class AccountCreateBodyIndividualRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyIndividualRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyIndividualRegisteredAddress handling case conversions
