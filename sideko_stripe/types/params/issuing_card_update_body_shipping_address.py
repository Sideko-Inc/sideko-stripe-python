...
class IssuingCardUpdateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingCardUpdateBodyShippingAddress(pydantic.BaseModel):
    """
    Serializer for IssuingCardUpdateBodyShippingAddress handling case conversions
