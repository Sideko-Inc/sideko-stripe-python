...
class PaymentIntentUpdateBodyShippingObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentUpdateBodyShippingObj0Address(pydantic.BaseModel):
    """
    Serializer for PaymentIntentUpdateBodyShippingObj0Address handling case conversions
