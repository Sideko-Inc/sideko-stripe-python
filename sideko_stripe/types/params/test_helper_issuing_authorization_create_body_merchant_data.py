...
class TestHelperIssuingAuthorizationCreateBodyMerchantData(typing_extensions.TypedDict):
    """
...
class _SerializerTestHelperIssuingAuthorizationCreateBodyMerchantData(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingAuthorizationCreateBodyMerchantData handling case conversions
