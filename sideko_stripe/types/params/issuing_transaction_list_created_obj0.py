...
class IssuingTransactionListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingTransactionListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for IssuingTransactionListCreatedObj0 handling case conversions
