...
class CustomerSubscriptionModifyBodyItemsItemDiscountsArr0Item(
...
class _SerializerCustomerSubscriptionModifyBodyItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionModifyBodyItemsItemDiscountsArr0Item handling case conversions
