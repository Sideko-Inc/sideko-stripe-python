...
class TokenCreateBodyAccountIndividualRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountIndividualRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountIndividualRegisteredAddress handling case conversions
