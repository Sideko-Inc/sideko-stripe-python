...
class PayoutListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPayoutListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for PayoutListCreatedObj0 handling case conversions
