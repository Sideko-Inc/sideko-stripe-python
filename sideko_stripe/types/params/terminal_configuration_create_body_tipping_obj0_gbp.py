...
class TerminalConfigurationCreateBodyTippingObj0Gbp(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Gbp(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Gbp handling case conversions
