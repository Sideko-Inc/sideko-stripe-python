...
class CustomerSubscriptionCreateBodyAddInvoiceItemsItemPriceData(
...
class _SerializerCustomerSubscriptionCreateBodyAddInvoiceItemsItemPriceData(
    pydantic.BaseModel
):
    """
    Serializer for CustomerSubscriptionCreateBodyAddInvoiceItemsItemPriceData handling case conversions
