...
class DisputeListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerDisputeListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for DisputeListCreatedObj0 handling case conversions
