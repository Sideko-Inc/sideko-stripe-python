...
class PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0ThreeDSecureNetworkOptionsCartesBancaires(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsCardObj0ThreeDSecureNetworkOptionsCartesBancaires(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsCardObj0ThreeDSecureNetworkOptionsCartesBancaires handling case conversions
