...
class PaymentMethodConfigurationCreateBodyPaynowDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyPaynowDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyPaynowDisplayPreference handling case conversions
