...
class AccountExternalAccountCreateBody(typing_extensions.TypedDict, total=False):
    """
    AccountExternalAccountCreateBody
    """

    bank_account: typing_extensions.NotRequired[
        typing.Union[AccountExternalAccountCreateBodyBankAccountObj0, str]
    ]
    """
    ...
    metadata: typing_extensions.NotRequired[AccountExternalAccountCreateBodyMetadata]
    """
    Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
    """


class _SerializerAccountExternalAccountCreateBody(pydantic.BaseModel):
    """
    Serializer for AccountExternalAccountCreateBody handling case conversions
    ...
    bank_account: typing.Optional[
        typing.Union[_SerializerAccountExternalAccountCreateBodyBankAccountObj0, str]
    ...
    metadata: typing.Optional[_SerializerAccountExternalAccountCreateBodyMetadata] = (
