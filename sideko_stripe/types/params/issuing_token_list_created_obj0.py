...
class IssuingTokenListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingTokenListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for IssuingTokenListCreatedObj0 handling case conversions
