...
class AccountPeopleCreateBodyRegisteredAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyRegisteredAddress(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyRegisteredAddress handling case conversions
