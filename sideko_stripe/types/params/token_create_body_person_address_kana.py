...
class TokenCreateBodyPersonAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonAddressKana(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyPersonAddressKana handling case conversions
