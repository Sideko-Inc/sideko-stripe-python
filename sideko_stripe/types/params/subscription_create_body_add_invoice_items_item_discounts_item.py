...
class SubscriptionCreateBodyAddInvoiceItemsItemDiscountsItem(
...
class _SerializerSubscriptionCreateBodyAddInvoiceItemsItemDiscountsItem(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionCreateBodyAddInvoiceItemsItemDiscountsItem handling case conversions
