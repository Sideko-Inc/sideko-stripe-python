...
class TerminalConfigurationCreateBodyTippingObj0Dkk(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Dkk(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Dkk handling case conversions
