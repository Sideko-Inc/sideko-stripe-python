...
class PaymentIntentUpdateBodyPaymentMethodOptionsKakaoPayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsKakaoPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsKakaoPayObj0 handling case conversions
