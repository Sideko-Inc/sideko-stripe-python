...
class PaymentIntentCreateBodyPaymentMethodOptionsKlarnaObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsKlarnaObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsKlarnaObj0 handling case conversions
