...
class AccountPersonUpdateBodyRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonUpdateBodyRelationship(pydantic.BaseModel):
    """
    Serializer for AccountPersonUpdateBodyRelationship handling case conversions
