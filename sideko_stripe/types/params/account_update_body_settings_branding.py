...
class AccountUpdateBodySettingsBranding(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodySettingsBranding(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodySettingsBranding handling case conversions
