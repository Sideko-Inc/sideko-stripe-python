...
class InvoicePreviewBodyScheduleDetailsPhasesItemDiscountsArr0Item(
...
class _SerializerInvoicePreviewBodyScheduleDetailsPhasesItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyScheduleDetailsPhasesItemDiscountsArr0Item handling case conversions
