...
class PaymentMethodConfigurationUpdateBodyAlipayDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyAlipayDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyAlipayDisplayPreference handling case conversions
