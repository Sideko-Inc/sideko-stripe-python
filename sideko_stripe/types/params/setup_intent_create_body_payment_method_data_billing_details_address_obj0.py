...
class SetupIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerSetupIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
