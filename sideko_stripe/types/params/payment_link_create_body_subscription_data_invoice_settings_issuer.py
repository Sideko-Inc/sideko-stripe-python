...
class PaymentLinkCreateBodySubscriptionDataInvoiceSettingsIssuer(
...
class _SerializerPaymentLinkCreateBodySubscriptionDataInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for PaymentLinkCreateBodySubscriptionDataInvoiceSettingsIssuer handling case conversions
