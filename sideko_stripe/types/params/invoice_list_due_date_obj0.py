...
class InvoiceListDueDateObj0(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceListDueDateObj0(pydantic.BaseModel):
    """
    Serializer for InvoiceListDueDateObj0 handling case conversions
