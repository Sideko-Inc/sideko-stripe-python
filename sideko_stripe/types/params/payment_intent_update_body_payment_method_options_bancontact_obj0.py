...
class PaymentIntentUpdateBodyPaymentMethodOptionsBancontactObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsBancontactObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsBancontactObj0 handling case conversions
