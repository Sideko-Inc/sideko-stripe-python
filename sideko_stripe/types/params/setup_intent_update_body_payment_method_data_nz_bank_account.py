...
class SetupIntentUpdateBodyPaymentMethodDataNzBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentUpdateBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodDataNzBankAccount handling case conversions
