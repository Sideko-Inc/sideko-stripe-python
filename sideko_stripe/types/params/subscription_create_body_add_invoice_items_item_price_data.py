...
class SubscriptionCreateBodyAddInvoiceItemsItemPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyAddInvoiceItemsItemPriceData(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyAddInvoiceItemsItemPriceData handling case conversions
