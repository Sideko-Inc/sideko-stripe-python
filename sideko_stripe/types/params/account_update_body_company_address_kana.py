...
class AccountUpdateBodyCompanyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyCompanyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyCompanyAddressKana handling case conversions
