...
class TestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFleetCardholderPromptData(
...
class _SerializerTestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFleetCardholderPromptData(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFleetCardholderPromptData handling case conversions
