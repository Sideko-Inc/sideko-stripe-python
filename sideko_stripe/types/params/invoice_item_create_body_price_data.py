...
class InvoiceItemCreateBodyPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceItemCreateBodyPriceData(pydantic.BaseModel):
    """
    Serializer for InvoiceItemCreateBodyPriceData handling case conversions
