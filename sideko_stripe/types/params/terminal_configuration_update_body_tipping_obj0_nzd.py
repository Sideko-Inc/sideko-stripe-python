...
class TerminalConfigurationUpdateBodyTippingObj0Nzd(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Nzd(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Nzd handling case conversions
