...
class AccountPeopleUpdateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    address: typing_extensions.NotRequired[AccountPeopleUpdateBodyAddress]
    """
    The person's address.
    """

    address_kana: typing_extensions.NotRequired[AccountPeopleUpdateBodyAddressKana]
    """
    The Kana variation of the person's address (Japan only).
    """

    address_kanji: typing_extensions.NotRequired[AccountPeopleUpdateBodyAddressKanji]
    """
    The Kanji variation of the person's address (Japan only).
    """

    dob: typing_extensions.NotRequired[
        typing.Union[AccountPeopleUpdateBodyDobObj0, str]
    ]
    """
    The person's date of birth.
    """

    documents: typing_extensions.NotRequired[AccountPeopleUpdateBodyDocuments]
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[AccountPeopleUpdateBodyMetadataObj0, str]
    ]
    """
    ...
    relationship: typing_extensions.NotRequired[AccountPeopleUpdateBodyRelationship]
    """
    ...
    verification: typing_extensions.NotRequired[AccountPeopleUpdateBodyVerification]
    """
    The person's verification status.
    """


class _SerializerAccountPeopleUpdateBody(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBody handling case conversions
    ...
    address: typing.Optional[_SerializerAccountPeopleUpdateBodyAddress] = (
        pydantic.Field(alias="address", default=None)
    )
    address_kana: typing.Optional[_SerializerAccountPeopleUpdateBodyAddressKana] = (
        pydantic.Field(alias="address_kana", default=None)
    )
    address_kanji: typing.Optional[_SerializerAccountPeopleUpdateBodyAddressKanji] = (
        pydantic.Field(alias="address_kanji", default=None)
    )
    dob: typing.Optional[
        typing.Union[_SerializerAccountPeopleUpdateBodyDobObj0, str]
    ] = pydantic.Field(alias="dob", default=None)
    documents: typing.Optional[_SerializerAccountPeopleUpdateBodyDocuments] = (
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerAccountPeopleUpdateBodyMetadataObj0, str]
    ...
    relationship: typing.Optional[_SerializerAccountPeopleUpdateBodyRelationship] = (
    ...
    verification: typing.Optional[_SerializerAccountPeopleUpdateBodyVerification] = (
