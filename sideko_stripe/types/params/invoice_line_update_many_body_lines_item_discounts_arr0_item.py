...
class InvoiceLineUpdateManyBodyLinesItemDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceLineUpdateManyBodyLinesItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for InvoiceLineUpdateManyBodyLinesItemDiscountsArr0Item handling case conversions
