...
class CheckoutSessionCreateBodyPaymentMethodOptionsNaverPay(
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsNaverPay(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsNaverPay handling case conversions
