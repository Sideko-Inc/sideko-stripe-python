...
class PaymentIntentUpdateBodyPaymentMethodOptionsCashappObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsCashappObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsCashappObj0 handling case conversions
