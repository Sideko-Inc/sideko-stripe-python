...
class SetupIntentCreateBodyPaymentMethodOptionsCardMandateOptions(
...
class _SerializerSetupIntentCreateBodyPaymentMethodOptionsCardMandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentCreateBodyPaymentMethodOptionsCardMandateOptions handling case conversions
