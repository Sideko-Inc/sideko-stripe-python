...
class PaymentIntentConfirmBodyPaymentMethodOptionsKakaoPayObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsKakaoPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsKakaoPayObj0 handling case conversions
