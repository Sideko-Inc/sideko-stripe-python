...
class AccountCreateBodyCompanyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyCompanyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyCompanyAddressKana handling case conversions
