...
class SetupIntentVerifyMicrodepositsBody(typing_extensions.TypedDict, total=False):
    """
...
class _SerializerSetupIntentVerifyMicrodepositsBody(pydantic.BaseModel):
    """
    Serializer for SetupIntentVerifyMicrodepositsBody handling case conversions
