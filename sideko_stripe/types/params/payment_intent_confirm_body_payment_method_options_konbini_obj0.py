...
class PaymentIntentConfirmBodyPaymentMethodOptionsKonbiniObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsKonbiniObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsKonbiniObj0 handling case conversions
