...
class TreasuryFinancialAccountCloseBodyForwardingSettings(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryFinancialAccountCloseBodyForwardingSettings(
    pydantic.BaseModel
):
    """
    Serializer for TreasuryFinancialAccountCloseBodyForwardingSettings handling case conversions
