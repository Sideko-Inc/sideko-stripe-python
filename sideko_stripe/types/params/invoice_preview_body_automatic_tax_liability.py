...
class InvoicePreviewBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for InvoicePreviewBodyAutomaticTaxLiability handling case conversions
