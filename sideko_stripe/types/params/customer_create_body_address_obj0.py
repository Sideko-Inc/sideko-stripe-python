...
class CustomerCreateBodyAddressObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerCreateBodyAddressObj0(pydantic.BaseModel):
    """
    Serializer for CustomerCreateBodyAddressObj0 handling case conversions
