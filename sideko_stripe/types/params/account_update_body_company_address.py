...
class AccountUpdateBodyCompanyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyCompanyAddress(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyCompanyAddress handling case conversions
