...
class PaymentIntentConfirmBodyPaymentMethodOptionsKlarnaObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsKlarnaObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsKlarnaObj0 handling case conversions
