...
class PaymentIntentUpdateBodyPaymentMethodOptionsAcssDebitObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsAcssDebitObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsAcssDebitObj0 handling case conversions
