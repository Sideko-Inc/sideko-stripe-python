...
class SubscriptionScheduleUpdateBodyPhasesItemItemsItemPriceData(
...
class _SerializerSubscriptionScheduleUpdateBodyPhasesItemItemsItemPriceData(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyPhasesItemItemsItemPriceData handling case conversions
    ...
    recurring: _SerializerSubscriptionScheduleUpdateBodyPhasesItemItemsItemPriceDataRecurring = pydantic.Field(
        alias="recurring",
    )
