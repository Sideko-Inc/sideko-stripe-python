...
class CustomerCardUpdateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[CustomerCardUpdateBodyMetadataObj0, str]
    ]
    """
    ...
    owner: typing_extensions.NotRequired[CustomerCardUpdateBodyOwner]


class _SerializerCustomerCardUpdateBody(pydantic.BaseModel):
    """
    Serializer for CustomerCardUpdateBody handling case conversions
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerCustomerCardUpdateBodyMetadataObj0, str]
    ] = pydantic.Field(alias="metadata", default=None)
    name: typing.Optional[str] = pydantic.Field(alias="name", default=None)
    owner: typing.Optional[_SerializerCustomerCardUpdateBodyOwner] = pydantic.Field(
