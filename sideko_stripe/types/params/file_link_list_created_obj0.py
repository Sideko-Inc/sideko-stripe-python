...
class FileLinkListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerFileLinkListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for FileLinkListCreatedObj0 handling case conversions
