...
class TestHelperIssuingTransactionCreateUnlinkedRefundBodyMerchantData(
    ...
    network_id: typing_extensions.NotRequired[str]
...
class _SerializerTestHelperIssuingTransactionCreateUnlinkedRefundBodyMerchantData(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateUnlinkedRefundBodyMerchantData handling case conversions
    ...
    network_id: typing.Optional[str] = pydantic.Field(alias="network_id", default=None)
