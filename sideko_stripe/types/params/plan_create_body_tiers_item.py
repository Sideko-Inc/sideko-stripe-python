...
class PlanCreateBodyTiersItem(typing_extensions.TypedDict):
    """
...
class _SerializerPlanCreateBodyTiersItem(pydantic.BaseModel):
    """
    Serializer for PlanCreateBodyTiersItem handling case conversions
