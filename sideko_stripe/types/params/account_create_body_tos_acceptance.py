...
class AccountCreateBodyTosAcceptance(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyTosAcceptance(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyTosAcceptance handling case conversions
