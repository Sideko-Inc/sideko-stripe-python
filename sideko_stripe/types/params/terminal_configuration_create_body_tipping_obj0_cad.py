...
class TerminalConfigurationCreateBodyTippingObj0Cad(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Cad(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Cad handling case conversions
