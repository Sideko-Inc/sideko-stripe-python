...
class AccountCreateBodyIndividualAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyIndividualAddress(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyIndividualAddress handling case conversions
