...
class SubscriptionUpdateBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionUpdateBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for SubscriptionUpdateBodyAutomaticTaxLiability handling case conversions
