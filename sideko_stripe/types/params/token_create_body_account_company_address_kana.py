...
class TokenCreateBodyAccountCompanyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountCompanyAddressKana(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountCompanyAddressKana handling case conversions
