...
class FinancialConnectionsTransactionListTransactedAtObj0(typing_extensions.TypedDict):
    """
...
class _SerializerFinancialConnectionsTransactionListTransactedAtObj0(
    pydantic.BaseModel
):
    """
    Serializer for FinancialConnectionsTransactionListTransactedAtObj0 handling case conversions
