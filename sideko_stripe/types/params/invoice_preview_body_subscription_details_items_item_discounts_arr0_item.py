...
class InvoicePreviewBodySubscriptionDetailsItemsItemDiscountsArr0Item(
...
class _SerializerInvoicePreviewBodySubscriptionDetailsItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodySubscriptionDetailsItemsItemDiscountsArr0Item handling case conversions
