...
class TestHelperIssuingTransactionCreateForceCaptureBodyMerchantData(
...
class _SerializerTestHelperIssuingTransactionCreateForceCaptureBodyMerchantData(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateForceCaptureBodyMerchantData handling case conversions
