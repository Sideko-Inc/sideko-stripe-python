...
class PaymentIntentConfirmBodyPaymentMethodDataNzBankAccount(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodDataNzBankAccount handling case conversions
