...
class InvoiceUpdateBody(typing_extensions.TypedDict, total=False):
    """
    InvoiceUpdateBody
    """
    ...
    automatic_tax: typing_extensions.NotRequired[InvoiceUpdateBodyAutomaticTax]
    """
    ...
    custom_fields: typing_extensions.NotRequired[
        typing.Union[typing.List[InvoiceUpdateBodyCustomFieldsArr0Item], str]
    ]
    """
    ...
    discounts: typing_extensions.NotRequired[
        typing.Union[typing.List[InvoiceUpdateBodyDiscountsArr0Item], str]
    ]
    """
    ...
    effective_at: typing_extensions.NotRequired[typing.Union[int, str]]
    """
    ...
    issuer: typing_extensions.NotRequired[InvoiceUpdateBodyIssuer]
    """
    The connected account that issues the invoice. The invoice is presented with the branding and support information of the specified account.
    """

    metadata: typing_extensions.NotRequired[
        typing.Union[InvoiceUpdateBodyMetadataObj0, str]
    ]
    """
    Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
    """

    number: typing_extensions.NotRequired[typing.Union[str, str]]
    """
    ...
    payment_settings: typing_extensions.NotRequired[InvoiceUpdateBodyPaymentSettings]
    """
    Configuration settings for the PaymentIntent that is generated when the invoice is finalized.
    """

    rendering: typing_extensions.NotRequired[InvoiceUpdateBodyRendering]
    """
    The rendering-related settings that control how the invoice is displayed on customer-facing surfaces such as PDF and Hosted Invoice Page.
    """

    shipping_cost: typing_extensions.NotRequired[
        typing.Union[InvoiceUpdateBodyShippingCostObj0, str]
    ]
    """
    ...
    shipping_details: typing_extensions.NotRequired[
        typing.Union[InvoiceUpdateBodyShippingDetailsObj0, str]
    ]
    """
    ...
    transfer_data: typing_extensions.NotRequired[
        typing.Union[InvoiceUpdateBodyTransferDataObj0, str]
    ]
    """
...
class _SerializerInvoiceUpdateBody(pydantic.BaseModel):
    """
    Serializer for InvoiceUpdateBody handling case conversions
    ...
    automatic_tax: typing.Optional[_SerializerInvoiceUpdateBodyAutomaticTax] = (
    ...
    custom_fields: typing.Optional[
        typing.Union[typing.List[_SerializerInvoiceUpdateBodyCustomFieldsArr0Item], str]
    ...
    discounts: typing.Optional[
        typing.Union[typing.List[_SerializerInvoiceUpdateBodyDiscountsArr0Item], str]
    ] = pydantic.Field(alias="discounts", default=None)
    due_date: typing.Optional[int] = pydantic.Field(alias="due_date", default=None)
    effective_at: typing.Optional[typing.Union[int, str]] = pydantic.Field(
    ...
    issuer: typing.Optional[_SerializerInvoiceUpdateBodyIssuer] = pydantic.Field(
        alias="issuer", default=None
    )
    metadata: typing.Optional[
        typing.Union[_SerializerInvoiceUpdateBodyMetadataObj0, str]
    ] = pydantic.Field(alias="metadata", default=None)
    number: typing.Optional[typing.Union[str, str]] = pydantic.Field(
        alias="number", default=None
    )
    on_behalf_of: typing.Optional[typing.Union[str, str]] = pydantic.Field(
        alias="on_behalf_of", default=None
    )
    payment_settings: typing.Optional[_SerializerInvoiceUpdateBodyPaymentSettings] = (
        pydantic.Field(alias="payment_settings", default=None)
    )
    rendering: typing.Optional[_SerializerInvoiceUpdateBodyRendering] = pydantic.Field(
        alias="rendering", default=None
    )
    shipping_cost: typing.Optional[
        typing.Union[_SerializerInvoiceUpdateBodyShippingCostObj0, str]
    ] = pydantic.Field(alias="shipping_cost", default=None)
    shipping_details: typing.Optional[
        typing.Union[_SerializerInvoiceUpdateBodyShippingDetailsObj0, str]
    ...
    transfer_data: typing.Optional[
        typing.Union[_SerializerInvoiceUpdateBodyTransferDataObj0, str]
