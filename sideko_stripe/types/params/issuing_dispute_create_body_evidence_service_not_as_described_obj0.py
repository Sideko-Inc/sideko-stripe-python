...
class IssuingDisputeCreateBodyEvidenceServiceNotAsDescribedObj0(
...
class _SerializerIssuingDisputeCreateBodyEvidenceServiceNotAsDescribedObj0(
    pydantic.BaseModel
):
    """
    Serializer for IssuingDisputeCreateBodyEvidenceServiceNotAsDescribedObj0 handling case conversions
