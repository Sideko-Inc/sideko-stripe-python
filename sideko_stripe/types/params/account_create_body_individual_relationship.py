...
class AccountCreateBodyIndividualRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyIndividualRelationship(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyIndividualRelationship handling case conversions
