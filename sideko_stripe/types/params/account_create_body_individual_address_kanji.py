...
class AccountCreateBodyIndividualAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyIndividualAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyIndividualAddressKanji handling case conversions
