...
class QuoteCreateBodyInvoiceSettingsIssuer(typing_extensions.TypedDict):
    """
...
class _SerializerQuoteCreateBodyInvoiceSettingsIssuer(pydantic.BaseModel):
    """
    Serializer for QuoteCreateBodyInvoiceSettingsIssuer handling case conversions
