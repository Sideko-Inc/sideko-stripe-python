...
class PaymentIntentConfirmBodyPaymentMethodOptionsKrCardObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsKrCardObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsKrCardObj0 handling case conversions
