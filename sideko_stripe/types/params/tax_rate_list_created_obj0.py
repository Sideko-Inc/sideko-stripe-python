...
class TaxRateListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTaxRateListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for TaxRateListCreatedObj0 handling case conversions
