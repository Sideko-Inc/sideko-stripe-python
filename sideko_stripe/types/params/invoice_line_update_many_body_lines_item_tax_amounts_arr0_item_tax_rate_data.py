...
class InvoiceLineUpdateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData(
...
class _SerializerInvoiceLineUpdateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData(
    pydantic.BaseModel
):
    """
    Serializer for InvoiceLineUpdateManyBodyLinesItemTaxAmountsArr0ItemTaxRateData handling case conversions
