...
class CheckoutSessionCreateBodyPaymentIntentDataShippingAddress(
...
class _SerializerCheckoutSessionCreateBodyPaymentIntentDataShippingAddress(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentIntentDataShippingAddress handling case conversions
