...
class PaymentIntentUpdateBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
