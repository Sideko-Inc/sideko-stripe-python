...
class PaymentIntentConfirmBodyPaymentMethodOptionsAmazonPayObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsAmazonPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsAmazonPayObj0 handling case conversions
