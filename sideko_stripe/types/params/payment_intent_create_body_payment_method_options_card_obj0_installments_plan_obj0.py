...
class PaymentIntentCreateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsCardObj0InstallmentsPlanObj0 handling case conversions
