...
class SourceCreateBodyOwnerAddress(typing_extensions.TypedDict):
    """
...
class _SerializerSourceCreateBodyOwnerAddress(pydantic.BaseModel):
    """
    Serializer for SourceCreateBodyOwnerAddress handling case conversions
