...
class SetupIntentUpdateBodyPaymentMethodDataBacsDebit(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentUpdateBodyPaymentMethodDataBacsDebit(pydantic.BaseModel):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodDataBacsDebit handling case conversions
