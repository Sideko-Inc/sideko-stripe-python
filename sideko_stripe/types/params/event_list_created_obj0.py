...
class EventListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerEventListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for EventListCreatedObj0 handling case conversions
