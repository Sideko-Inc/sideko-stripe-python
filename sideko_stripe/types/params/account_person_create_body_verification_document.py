...
class AccountPersonCreateBodyVerificationDocument(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonCreateBodyVerificationDocument(pydantic.BaseModel):
    """
    Serializer for AccountPersonCreateBodyVerificationDocument handling case conversions
