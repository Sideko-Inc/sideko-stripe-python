...
class InvoiceItemUpdateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceItemUpdateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for InvoiceItemUpdateBodyDiscountsArr0Item handling case conversions
