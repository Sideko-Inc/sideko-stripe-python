...
class RadarValueListItemListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerRadarValueListItemListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for RadarValueListItemListCreatedObj0 handling case conversions
