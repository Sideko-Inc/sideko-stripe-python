...
class CustomerCardCreateBodyBankAccountObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerCardCreateBodyBankAccountObj0(pydantic.BaseModel):
    """
    Serializer for CustomerCardCreateBodyBankAccountObj0 handling case conversions
