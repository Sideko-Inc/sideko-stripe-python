...
class SetupIntentCreateBodyPaymentMethodDataNzBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentCreateBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentCreateBodyPaymentMethodDataNzBankAccount handling case conversions
