...
class PaymentMethodConfigurationCreateBodyGrabpayDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyGrabpayDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyGrabpayDisplayPreference handling case conversions
