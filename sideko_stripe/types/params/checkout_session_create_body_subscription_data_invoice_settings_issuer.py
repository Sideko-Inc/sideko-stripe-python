...
class CheckoutSessionCreateBodySubscriptionDataInvoiceSettingsIssuer(
...
class _SerializerCheckoutSessionCreateBodySubscriptionDataInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodySubscriptionDataInvoiceSettingsIssuer handling case conversions
