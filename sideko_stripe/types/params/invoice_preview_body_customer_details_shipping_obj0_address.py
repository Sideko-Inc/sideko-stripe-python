...
class InvoicePreviewBodyCustomerDetailsShippingObj0Address(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyCustomerDetailsShippingObj0Address(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyCustomerDetailsShippingObj0Address handling case conversions
