...
class AccountCreateBodyCompanyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyCompanyAddress(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyCompanyAddress handling case conversions
