...
class TaxIdCreateBodyOwner(typing_extensions.TypedDict):
    """
...
class _SerializerTaxIdCreateBodyOwner(pydantic.BaseModel):
    """
    Serializer for TaxIdCreateBodyOwner handling case conversions
