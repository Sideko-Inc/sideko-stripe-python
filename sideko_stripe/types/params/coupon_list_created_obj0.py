...
class CouponListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCouponListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for CouponListCreatedObj0 handling case conversions
