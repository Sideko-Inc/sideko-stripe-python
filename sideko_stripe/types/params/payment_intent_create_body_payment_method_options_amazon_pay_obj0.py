...
class PaymentIntentCreateBodyPaymentMethodOptionsAmazonPayObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsAmazonPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsAmazonPayObj0 handling case conversions
