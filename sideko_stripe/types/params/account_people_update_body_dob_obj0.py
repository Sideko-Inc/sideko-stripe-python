...
class AccountPeopleUpdateBodyDobObj0(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyDobObj0(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyDobObj0 handling case conversions
