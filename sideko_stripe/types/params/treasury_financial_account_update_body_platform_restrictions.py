...
class TreasuryFinancialAccountUpdateBodyPlatformRestrictions(
...
class _SerializerTreasuryFinancialAccountUpdateBodyPlatformRestrictions(
    pydantic.BaseModel
):
    """
    Serializer for TreasuryFinancialAccountUpdateBodyPlatformRestrictions handling case conversions
