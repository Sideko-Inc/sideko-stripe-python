...
class AccountUpdateBodyIndividualAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyIndividualAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyIndividualAddressKana handling case conversions
