...
class IssuingDisputeCreateBodyEvidenceDuplicateObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingDisputeCreateBodyEvidenceDuplicateObj0(pydantic.BaseModel):
    """
    Serializer for IssuingDisputeCreateBodyEvidenceDuplicateObj0 handling case conversions
