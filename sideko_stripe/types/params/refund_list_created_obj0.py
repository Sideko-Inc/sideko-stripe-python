...
class RefundListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerRefundListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for RefundListCreatedObj0 handling case conversions
