...
class PaymentLinkUpdateBodyAutomaticTaxLiability(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentLinkUpdateBodyAutomaticTaxLiability(pydantic.BaseModel):
    """
    Serializer for PaymentLinkUpdateBodyAutomaticTaxLiability handling case conversions
