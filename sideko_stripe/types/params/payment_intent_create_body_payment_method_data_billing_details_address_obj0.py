...
class PaymentIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
