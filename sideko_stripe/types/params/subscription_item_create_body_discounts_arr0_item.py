...
class SubscriptionItemCreateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionItemCreateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for SubscriptionItemCreateBodyDiscountsArr0Item handling case conversions
