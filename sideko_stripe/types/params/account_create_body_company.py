...
class AccountCreateBodyCompany(typing_extensions.TypedDict):
    """
    Information about the company or business. This field is available for any `business_type`. Once you create an [Account Link](/api/account_links) or [Account Session](/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
    """

    address: typing_extensions.NotRequired[AccountCreateBodyCompanyAddress]

    address_kana: typing_extensions.NotRequired[AccountCreateBodyCompanyAddressKana]

    address_kanji: typing_extensions.NotRequired[AccountCreateBodyCompanyAddressKanji]
    ...
    verification: typing_extensions.NotRequired[AccountCreateBodyCompanyVerification]


class _SerializerAccountCreateBodyCompany(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyCompany handling case conversions
    ...
    address: typing.Optional[_SerializerAccountCreateBodyCompanyAddress] = (
        pydantic.Field(alias="address", default=None)
    )
    address_kana: typing.Optional[_SerializerAccountCreateBodyCompanyAddressKana] = (
        pydantic.Field(alias="address_kana", default=None)
    )
    address_kanji: typing.Optional[_SerializerAccountCreateBodyCompanyAddressKanji] = (
    ...
    verification: typing.Optional[_SerializerAccountCreateBodyCompanyVerification] = (
