...
class InvoicePreviewBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for InvoicePreviewBodyDiscountsArr0Item handling case conversions
