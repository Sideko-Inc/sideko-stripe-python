...
class PaymentIntentConfirmBodyPaymentMethodOptionsSofortObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsSofortObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsSofortObj0 handling case conversions
