...
class PaymentIntentCreateBodyPaymentMethodDataNzBankAccount(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodDataNzBankAccount handling case conversions
