...
class SetupIntentConfirmBodyPaymentMethodData(typing_extensions.TypedDict):
    """
    ...
    boleto: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataBoleto]
    ...
    eps: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataEps]

    fpx: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataFpx]
    ...
    ideal: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataIdeal]
    ...
    klarna: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataKlarna]
    ...
    p24: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataP24]
    ...
    sofort: typing_extensions.NotRequired[SetupIntentConfirmBodyPaymentMethodDataSofort]
...
class _SerializerSetupIntentConfirmBodyPaymentMethodData(pydantic.BaseModel):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodData handling case conversions
    ...
    eps: typing.Optional[_SerializerSetupIntentConfirmBodyPaymentMethodDataEps] = (
        pydantic.Field(alias="eps", default=None)
    )
    fpx: typing.Optional[_SerializerSetupIntentConfirmBodyPaymentMethodDataFpx] = (
    ...
    ideal: typing.Optional[_SerializerSetupIntentConfirmBodyPaymentMethodDataIdeal] = (
    ...
    p24: typing.Optional[_SerializerSetupIntentConfirmBodyPaymentMethodDataP24] = (
