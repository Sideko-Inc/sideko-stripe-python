...
class AccountPeopleUpdateBodyRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyRelationship(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyRelationship handling case conversions
