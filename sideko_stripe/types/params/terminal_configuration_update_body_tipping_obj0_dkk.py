...
class TerminalConfigurationUpdateBodyTippingObj0Dkk(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Dkk(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Dkk handling case conversions
