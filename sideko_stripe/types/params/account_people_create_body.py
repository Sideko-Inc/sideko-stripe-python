...
class AccountPeopleCreateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    address: typing_extensions.NotRequired[AccountPeopleCreateBodyAddress]
    """
    The person's address.
    """

    address_kana: typing_extensions.NotRequired[AccountPeopleCreateBodyAddressKana]
    """
    The Kana variation of the person's address (Japan only).
    """

    address_kanji: typing_extensions.NotRequired[AccountPeopleCreateBodyAddressKanji]
    """
    The Kanji variation of the person's address (Japan only).
    """

    dob: typing_extensions.NotRequired[
        typing.Union[AccountPeopleCreateBodyDobObj0, str]
    ]
    """
    The person's date of birth.
    """

    documents: typing_extensions.NotRequired[AccountPeopleCreateBodyDocuments]
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[AccountPeopleCreateBodyMetadataObj0, str]
    ]
    """
    ...
    relationship: typing_extensions.NotRequired[AccountPeopleCreateBodyRelationship]
    """
    ...
    verification: typing_extensions.NotRequired[AccountPeopleCreateBodyVerification]
    """
    The person's verification status.
    """


class _SerializerAccountPeopleCreateBody(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBody handling case conversions
    ...
    address: typing.Optional[_SerializerAccountPeopleCreateBodyAddress] = (
        pydantic.Field(alias="address", default=None)
    )
    address_kana: typing.Optional[_SerializerAccountPeopleCreateBodyAddressKana] = (
        pydantic.Field(alias="address_kana", default=None)
    )
    address_kanji: typing.Optional[_SerializerAccountPeopleCreateBodyAddressKanji] = (
        pydantic.Field(alias="address_kanji", default=None)
    )
    dob: typing.Optional[
        typing.Union[_SerializerAccountPeopleCreateBodyDobObj0, str]
    ] = pydantic.Field(alias="dob", default=None)
    documents: typing.Optional[_SerializerAccountPeopleCreateBodyDocuments] = (
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerAccountPeopleCreateBodyMetadataObj0, str]
    ...
    relationship: typing.Optional[_SerializerAccountPeopleCreateBodyRelationship] = (
    ...
    verification: typing.Optional[_SerializerAccountPeopleCreateBodyVerification] = (
