...
class SubscriptionScheduleCreateBodyPhasesItemAutomaticTaxLiability(
...
class _SerializerSubscriptionScheduleCreateBodyPhasesItemAutomaticTaxLiability(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleCreateBodyPhasesItemAutomaticTaxLiability handling case conversions
