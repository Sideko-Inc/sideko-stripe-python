...
class PaymentIntentConfirmBodyPaymentMethodOptionsMobilepayObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsMobilepayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsMobilepayObj0 handling case conversions
