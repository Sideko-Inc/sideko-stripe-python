...
class AccountPeopleCreateBodyAdditionalTosAcceptancesAccount(
...
class _SerializerAccountPeopleCreateBodyAdditionalTosAcceptancesAccount(
    pydantic.BaseModel
):
    """
    Serializer for AccountPeopleCreateBodyAdditionalTosAcceptancesAccount handling case conversions
