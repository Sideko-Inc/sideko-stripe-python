...
class SetupIntentUpdateBodyPaymentMethodOptionsAcssDebitMandateOptions(
...
class _SerializerSetupIntentUpdateBodyPaymentMethodOptionsAcssDebitMandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodOptionsAcssDebitMandateOptions handling case conversions
