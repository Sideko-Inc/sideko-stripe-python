...
class InvoiceItemUpdateBodyPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceItemUpdateBodyPriceData(pydantic.BaseModel):
    """
    Serializer for InvoiceItemUpdateBodyPriceData handling case conversions
