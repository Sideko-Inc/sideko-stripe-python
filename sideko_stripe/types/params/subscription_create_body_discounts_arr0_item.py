...
class SubscriptionCreateBodyDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyDiscountsArr0Item handling case conversions
