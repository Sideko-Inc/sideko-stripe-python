...
class IssuingDisputeCreateBodyEvidenceCanceledObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingDisputeCreateBodyEvidenceCanceledObj0(pydantic.BaseModel):
    """
    Serializer for IssuingDisputeCreateBodyEvidenceCanceledObj0 handling case conversions
