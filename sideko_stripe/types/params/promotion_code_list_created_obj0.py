...
class PromotionCodeListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPromotionCodeListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for PromotionCodeListCreatedObj0 handling case conversions
