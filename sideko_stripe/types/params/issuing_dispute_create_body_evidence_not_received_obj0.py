...
class IssuingDisputeCreateBodyEvidenceNotReceivedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIssuingDisputeCreateBodyEvidenceNotReceivedObj0(pydantic.BaseModel):
    """
    Serializer for IssuingDisputeCreateBodyEvidenceNotReceivedObj0 handling case conversions
