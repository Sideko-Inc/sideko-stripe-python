...
class SubscriptionDeleteBodyCancellationDetails(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionDeleteBodyCancellationDetails(pydantic.BaseModel):
    """
    Serializer for SubscriptionDeleteBodyCancellationDetails handling case conversions
