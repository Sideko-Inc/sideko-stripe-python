...
class AccountPeopleUpdateBodyAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyAddressKanji handling case conversions
