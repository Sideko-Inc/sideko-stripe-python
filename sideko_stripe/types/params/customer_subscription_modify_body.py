...
class CustomerSubscriptionModifyBody(typing_extensions.TypedDict, total=False):
    """
    CustomerSubscriptionModifyBody
    """

    add_invoice_items: typing_extensions.NotRequired[
        typing.List[CustomerSubscriptionModifyBodyAddInvoiceItemsItem]
    ]
    """
    ...
    discounts: typing_extensions.NotRequired[
        typing.Union[typing.List[CustomerSubscriptionModifyBodyDiscountsArr0Item], str]
    ]
    """
    ...
    items: typing_extensions.NotRequired[
        typing.List[CustomerSubscriptionModifyBodyItemsItem]
    ]
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[CustomerSubscriptionModifyBodyMetadataObj0, str]
    ]
    """
    ...
    pause_collection: typing_extensions.NotRequired[
        typing.Union[CustomerSubscriptionModifyBodyPauseCollectionObj0, str]
    ]
    """
    ...
    pending_invoice_item_interval: typing_extensions.NotRequired[
        typing.Union[CustomerSubscriptionModifyBodyPendingInvoiceItemIntervalObj0, str]
    ]
    """
    ...
    transfer_data: typing_extensions.NotRequired[
        typing.Union[CustomerSubscriptionModifyBodyTransferDataObj0, str]
    ]
    """
...
class _SerializerCustomerSubscriptionModifyBody(pydantic.BaseModel):
    """
    Serializer for CustomerSubscriptionModifyBody handling case conversions
    ...
    add_invoice_items: typing.Optional[
        typing.List[_SerializerCustomerSubscriptionModifyBodyAddInvoiceItemsItem]
    ...
    discounts: typing.Optional[
        typing.Union[
            typing.List[_SerializerCustomerSubscriptionModifyBodyDiscountsArr0Item], str
        ]
    ...
    items: typing.Optional[
        typing.List[_SerializerCustomerSubscriptionModifyBodyItemsItem]
    ] = pydantic.Field(alias="items", default=None)
    metadata: typing.Optional[
        typing.Union[_SerializerCustomerSubscriptionModifyBodyMetadataObj0, str]
    ] = pydantic.Field(alias="metadata", default=None)
    off_session: typing.Optional[bool] = pydantic.Field(
        alias="off_session", default=None
    )
    pause_collection: typing.Optional[
        typing.Union[_SerializerCustomerSubscriptionModifyBodyPauseCollectionObj0, str]
    ...
    pending_invoice_item_interval: typing.Optional[
        typing.Union[
            _SerializerCustomerSubscriptionModifyBodyPendingInvoiceItemIntervalObj0, str
        ]
    ...
    transfer_data: typing.Optional[
        typing.Union[_SerializerCustomerSubscriptionModifyBodyTransferDataObj0, str]
