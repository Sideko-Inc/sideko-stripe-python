...
class QuoteCreateBodyLineItemsItemDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerQuoteCreateBodyLineItemsItemDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for QuoteCreateBodyLineItemsItemDiscountsArr0Item handling case conversions
