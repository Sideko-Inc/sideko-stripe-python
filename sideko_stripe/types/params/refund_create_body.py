...
class RefundCreateBody(typing_extensions.TypedDict, total=False):
    """
    RefundCreateBody
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[RefundCreateBodyMetadataObj0, str]
    ]
    """
...
class _SerializerRefundCreateBody(pydantic.BaseModel):
    """
    Serializer for RefundCreateBody handling case conversions
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerRefundCreateBodyMetadataObj0, str]
