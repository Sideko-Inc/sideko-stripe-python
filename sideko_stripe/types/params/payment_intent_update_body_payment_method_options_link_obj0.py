...
class PaymentIntentUpdateBodyPaymentMethodOptionsLinkObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsLinkObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsLinkObj0 handling case conversions
