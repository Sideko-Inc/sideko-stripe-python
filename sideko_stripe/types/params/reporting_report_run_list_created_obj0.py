...
class ReportingReportRunListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerReportingReportRunListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ReportingReportRunListCreatedObj0 handling case conversions
