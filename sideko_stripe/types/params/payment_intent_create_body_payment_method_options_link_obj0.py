...
class PaymentIntentCreateBodyPaymentMethodOptionsLinkObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsLinkObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsLinkObj0 handling case conversions
