...
class ReviewListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerReviewListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ReviewListCreatedObj0 handling case conversions
