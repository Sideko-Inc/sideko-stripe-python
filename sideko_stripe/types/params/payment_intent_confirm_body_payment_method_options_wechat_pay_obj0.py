...
class PaymentIntentConfirmBodyPaymentMethodOptionsWechatPayObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsWechatPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsWechatPayObj0 handling case conversions
