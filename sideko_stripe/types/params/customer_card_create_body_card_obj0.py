...
class CustomerCardCreateBodyCardObj0(typing_extensions.TypedDict):
    """
    ...
    metadata: typing_extensions.NotRequired[CustomerCardCreateBodyCardObj0Metadata]
...
class _SerializerCustomerCardCreateBodyCardObj0(pydantic.BaseModel):
    """
    Serializer for CustomerCardCreateBodyCardObj0 handling case conversions
    ...
    metadata: typing.Optional[_SerializerCustomerCardCreateBodyCardObj0Metadata] = (
