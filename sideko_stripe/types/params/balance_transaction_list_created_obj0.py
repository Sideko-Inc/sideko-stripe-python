...
class BalanceTransactionListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerBalanceTransactionListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for BalanceTransactionListCreatedObj0 handling case conversions
