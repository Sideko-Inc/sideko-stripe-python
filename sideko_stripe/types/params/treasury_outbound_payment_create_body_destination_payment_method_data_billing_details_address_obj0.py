...
class TreasuryOutboundPaymentCreateBodyDestinationPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerTreasuryOutboundPaymentCreateBodyDestinationPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for TreasuryOutboundPaymentCreateBodyDestinationPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
