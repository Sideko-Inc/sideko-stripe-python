...
class TerminalLocationUpdateBodyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalLocationUpdateBodyAddress(pydantic.BaseModel):
    """
    Serializer for TerminalLocationUpdateBodyAddress handling case conversions
