...
class SetupIntentCreateBodyPaymentMethodDataUsBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentCreateBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentCreateBodyPaymentMethodDataUsBankAccount handling case conversions
