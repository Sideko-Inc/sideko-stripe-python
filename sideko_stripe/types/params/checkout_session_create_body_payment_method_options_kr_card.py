...
class CheckoutSessionCreateBodyPaymentMethodOptionsKrCard(typing_extensions.TypedDict):
    """
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsKrCard(
    pydantic.BaseModel
):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsKrCard handling case conversions
