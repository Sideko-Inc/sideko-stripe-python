...
class SetupIntentConfirmBodyPaymentMethodDataNzBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentConfirmBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodDataNzBankAccount handling case conversions
