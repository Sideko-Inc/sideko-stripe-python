...
class PaymentIntentCreateBodyPaymentMethodOptionsAfterpayClearpayObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsAfterpayClearpayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsAfterpayClearpayObj0 handling case conversions
