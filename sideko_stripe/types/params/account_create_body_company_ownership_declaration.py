...
class AccountCreateBodyCompanyOwnershipDeclaration(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyCompanyOwnershipDeclaration(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyCompanyOwnershipDeclaration handling case conversions
