...
class SubscriptionScheduleCreateBodyPhasesItemInvoiceSettingsIssuer(
...
class _SerializerSubscriptionScheduleCreateBodyPhasesItemInvoiceSettingsIssuer(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleCreateBodyPhasesItemInvoiceSettingsIssuer handling case conversions
