...
class SubscriptionScheduleCreateBodyPhasesItemItemsItemDiscountsArr0Item(
...
class _SerializerSubscriptionScheduleCreateBodyPhasesItemItemsItemDiscountsArr0Item(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleCreateBodyPhasesItemItemsItemDiscountsArr0Item handling case conversions
