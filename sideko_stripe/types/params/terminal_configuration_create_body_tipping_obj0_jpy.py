...
class TerminalConfigurationCreateBodyTippingObj0Jpy(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Jpy(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Jpy handling case conversions
