...
class PaymentIntentConfirmBodyPaymentMethodDataAcssDebit(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodDataAcssDebit(pydantic.BaseModel):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodDataAcssDebit handling case conversions
