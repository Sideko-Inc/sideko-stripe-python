...
class SubscriptionCreateBodyItemsItemPriceDataRecurring(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyItemsItemPriceDataRecurring(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyItemsItemPriceDataRecurring handling case conversions
