...
class PaymentMethodConfigurationUpdateBodyOxxoDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyOxxoDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyOxxoDisplayPreference handling case conversions
