...
class SubscriptionCreateBodyItemsItemPriceData(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyItemsItemPriceData(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyItemsItemPriceData handling case conversions
    ...
    recurring: _SerializerSubscriptionCreateBodyItemsItemPriceDataRecurring = (
        pydantic.Field(
            alias="recurring",
        )
    )
