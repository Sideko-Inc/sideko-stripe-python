...
class AccountPeopleCreateBodyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyAddress(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyAddress handling case conversions
