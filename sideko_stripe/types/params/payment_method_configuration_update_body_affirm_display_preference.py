...
class PaymentMethodConfigurationUpdateBodyAffirmDisplayPreference(
...
class _SerializerPaymentMethodConfigurationUpdateBodyAffirmDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationUpdateBodyAffirmDisplayPreference handling case conversions
