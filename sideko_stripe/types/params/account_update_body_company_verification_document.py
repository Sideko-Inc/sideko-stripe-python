...
class AccountUpdateBodyCompanyVerificationDocument(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyCompanyVerificationDocument(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyCompanyVerificationDocument handling case conversions
