...
class InvoiceCreateBodyIssuer(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceCreateBodyIssuer(pydantic.BaseModel):
    """
    Serializer for InvoiceCreateBodyIssuer handling case conversions
