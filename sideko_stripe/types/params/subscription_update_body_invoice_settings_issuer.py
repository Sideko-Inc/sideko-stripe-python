...
class SubscriptionUpdateBodyInvoiceSettingsIssuer(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionUpdateBodyInvoiceSettingsIssuer(pydantic.BaseModel):
    """
    Serializer for SubscriptionUpdateBodyInvoiceSettingsIssuer handling case conversions
