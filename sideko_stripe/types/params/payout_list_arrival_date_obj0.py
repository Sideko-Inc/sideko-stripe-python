...
class PayoutListArrivalDateObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPayoutListArrivalDateObj0(pydantic.BaseModel):
    """
    Serializer for PayoutListArrivalDateObj0 handling case conversions
