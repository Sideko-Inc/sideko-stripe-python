...
class PaymentMethodConfigurationCreateBodyKonbiniDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyKonbiniDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyKonbiniDisplayPreference handling case conversions
