...
class PaymentIntentCreateBodyPaymentMethodOptionsAcssDebitObj0MandateOptions(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsAcssDebitObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsAcssDebitObj0MandateOptions handling case conversions
