...
class TestHelperConfirmationTokenCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerTestHelperConfirmationTokenCreateBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperConfirmationTokenCreateBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
