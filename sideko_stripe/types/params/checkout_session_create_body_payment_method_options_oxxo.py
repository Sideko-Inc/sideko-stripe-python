...
class CheckoutSessionCreateBodyPaymentMethodOptionsOxxo(typing_extensions.TypedDict):
    """
...
class _SerializerCheckoutSessionCreateBodyPaymentMethodOptionsOxxo(pydantic.BaseModel):
    """
    Serializer for CheckoutSessionCreateBodyPaymentMethodOptionsOxxo handling case conversions
