...
class TestHelperConfirmationTokenCreateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTestHelperConfirmationTokenCreateBodyShippingAddress(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperConfirmationTokenCreateBodyShippingAddress handling case conversions
