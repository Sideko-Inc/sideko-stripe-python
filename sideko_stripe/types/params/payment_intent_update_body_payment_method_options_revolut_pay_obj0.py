...
class PaymentIntentUpdateBodyPaymentMethodOptionsRevolutPayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsRevolutPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsRevolutPayObj0 handling case conversions
