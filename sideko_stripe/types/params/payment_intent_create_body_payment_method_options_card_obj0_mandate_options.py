...
class PaymentIntentCreateBodyPaymentMethodOptionsCardObj0MandateOptions(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsCardObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsCardObj0MandateOptions handling case conversions
