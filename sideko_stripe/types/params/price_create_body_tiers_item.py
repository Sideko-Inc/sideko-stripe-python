...
class PriceCreateBodyTiersItem(typing_extensions.TypedDict):
    """
...
class _SerializerPriceCreateBodyTiersItem(pydantic.BaseModel):
    """
    Serializer for PriceCreateBodyTiersItem handling case conversions
