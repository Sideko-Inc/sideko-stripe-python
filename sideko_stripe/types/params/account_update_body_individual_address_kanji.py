...
class AccountUpdateBodyIndividualAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerAccountUpdateBodyIndividualAddressKanji(pydantic.BaseModel):
    """
    Serializer for AccountUpdateBodyIndividualAddressKanji handling case conversions
