...
class TestHelperConfirmationTokenCreateBodyPaymentMethodDataNzBankAccount(
...
class _SerializerTestHelperConfirmationTokenCreateBodyPaymentMethodDataNzBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperConfirmationTokenCreateBodyPaymentMethodDataNzBankAccount handling case conversions
