...
class SourceUpdateBodyOwnerAddress(typing_extensions.TypedDict):
    """
...
class _SerializerSourceUpdateBodyOwnerAddress(pydantic.BaseModel):
    """
    Serializer for SourceUpdateBodyOwnerAddress handling case conversions
