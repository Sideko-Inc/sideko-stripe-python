...
class PaymentMethodConfigurationCreateBodyJcbDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyJcbDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyJcbDisplayPreference handling case conversions
