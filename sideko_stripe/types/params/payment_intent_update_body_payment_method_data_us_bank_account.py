...
class PaymentIntentUpdateBodyPaymentMethodDataUsBankAccount(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodDataUsBankAccount handling case conversions
