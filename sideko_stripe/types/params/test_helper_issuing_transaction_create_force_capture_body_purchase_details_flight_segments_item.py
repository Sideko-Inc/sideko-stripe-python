...
class TestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFlightSegmentsItem(
...
class _SerializerTestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFlightSegmentsItem(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateForceCaptureBodyPurchaseDetailsFlightSegmentsItem handling case conversions
