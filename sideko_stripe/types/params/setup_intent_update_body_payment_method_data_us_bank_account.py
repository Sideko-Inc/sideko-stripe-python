...
class SetupIntentUpdateBodyPaymentMethodDataUsBankAccount(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentUpdateBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentUpdateBodyPaymentMethodDataUsBankAccount handling case conversions
