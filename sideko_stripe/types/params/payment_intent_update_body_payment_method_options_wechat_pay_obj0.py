...
class PaymentIntentUpdateBodyPaymentMethodOptionsWechatPayObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsWechatPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsWechatPayObj0 handling case conversions
