...
class TestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFlightSegmentsItem(
...
class _SerializerTestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFlightSegmentsItem(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFlightSegmentsItem handling case conversions
