...
class TerminalConfigurationCreateBodyTippingObj0Czk(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Czk(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Czk handling case conversions
