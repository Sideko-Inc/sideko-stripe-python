...
class IssuingCardholderCreateBodyIndividualCardIssuingUserTermsAcceptance(
...
class _SerializerIssuingCardholderCreateBodyIndividualCardIssuingUserTermsAcceptance(
    pydantic.BaseModel
):
    """
    Serializer for IssuingCardholderCreateBodyIndividualCardIssuingUserTermsAcceptance handling case conversions
