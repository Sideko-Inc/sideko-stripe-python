...
class PriceListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPriceListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for PriceListCreatedObj0 handling case conversions
