...
class SetupIntentConfirmBodyPaymentMethodOptionsCardMandateOptions(
...
class _SerializerSetupIntentConfirmBodyPaymentMethodOptionsCardMandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodOptionsCardMandateOptions handling case conversions
