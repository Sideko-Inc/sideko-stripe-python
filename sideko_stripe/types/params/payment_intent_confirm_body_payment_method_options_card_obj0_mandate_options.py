...
class PaymentIntentConfirmBodyPaymentMethodOptionsCardObj0MandateOptions(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsCardObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsCardObj0MandateOptions handling case conversions
