...
class PaymentIntentCreateBodyPaymentMethodOptionsSwishObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsSwishObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsSwishObj0 handling case conversions
