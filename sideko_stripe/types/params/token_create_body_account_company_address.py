...
class TokenCreateBodyAccountCompanyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountCompanyAddress(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountCompanyAddress handling case conversions
