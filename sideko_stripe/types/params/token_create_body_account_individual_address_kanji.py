...
class TokenCreateBodyAccountIndividualAddressKanji(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountIndividualAddressKanji(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountIndividualAddressKanji handling case conversions
