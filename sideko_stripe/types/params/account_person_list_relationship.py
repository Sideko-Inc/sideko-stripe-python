...
class AccountPersonListRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonListRelationship(pydantic.BaseModel):
    """
    Serializer for AccountPersonListRelationship handling case conversions
