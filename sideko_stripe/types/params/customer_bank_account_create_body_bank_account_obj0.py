...
class CustomerBankAccountCreateBodyBankAccountObj0(typing_extensions.TypedDict):
    """
...
class _SerializerCustomerBankAccountCreateBodyBankAccountObj0(pydantic.BaseModel):
    """
    Serializer for CustomerBankAccountCreateBodyBankAccountObj0 handling case conversions
