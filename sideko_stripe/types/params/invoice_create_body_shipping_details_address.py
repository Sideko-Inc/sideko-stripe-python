...
class InvoiceCreateBodyShippingDetailsAddress(typing_extensions.TypedDict):
    """
...
class _SerializerInvoiceCreateBodyShippingDetailsAddress(pydantic.BaseModel):
    """
    Serializer for InvoiceCreateBodyShippingDetailsAddress handling case conversions
