...
class PaymentIntentConfirmBodyPaymentMethodOptionsPixObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsPixObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsPixObj0 handling case conversions
