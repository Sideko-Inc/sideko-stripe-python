...
class PaymentMethodConfigurationCreateBodyCashappDisplayPreference(
...
class _SerializerPaymentMethodConfigurationCreateBodyCashappDisplayPreference(
    pydantic.BaseModel
):
    """
    Serializer for PaymentMethodConfigurationCreateBodyCashappDisplayPreference handling case conversions
