...
class PaymentMethodCreateBodyBillingDetailsAddressObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentMethodCreateBodyBillingDetailsAddressObj0(pydantic.BaseModel):
    """
    Serializer for PaymentMethodCreateBodyBillingDetailsAddressObj0 handling case conversions
