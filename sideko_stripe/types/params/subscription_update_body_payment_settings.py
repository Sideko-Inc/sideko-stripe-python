...
class SubscriptionUpdateBodyPaymentSettings(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionUpdateBodyPaymentSettings(pydantic.BaseModel):
    """
    Serializer for SubscriptionUpdateBodyPaymentSettings handling case conversions
