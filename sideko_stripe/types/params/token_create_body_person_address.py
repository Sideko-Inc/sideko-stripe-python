...
class TokenCreateBodyPersonAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonAddress(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyPersonAddress handling case conversions
