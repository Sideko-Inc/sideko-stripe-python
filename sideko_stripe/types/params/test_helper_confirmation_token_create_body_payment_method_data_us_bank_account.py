...
class TestHelperConfirmationTokenCreateBodyPaymentMethodDataUsBankAccount(
...
class _SerializerTestHelperConfirmationTokenCreateBodyPaymentMethodDataUsBankAccount(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperConfirmationTokenCreateBodyPaymentMethodDataUsBankAccount handling case conversions
