...
class SubscriptionCreateBodyItemsItemDiscountsArr0Item(typing_extensions.TypedDict):
    """
...
class _SerializerSubscriptionCreateBodyItemsItemDiscountsArr0Item(pydantic.BaseModel):
    """
    Serializer for SubscriptionCreateBodyItemsItemDiscountsArr0Item handling case conversions
