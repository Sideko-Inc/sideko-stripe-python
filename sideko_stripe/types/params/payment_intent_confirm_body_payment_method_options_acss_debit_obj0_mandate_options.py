...
class PaymentIntentConfirmBodyPaymentMethodOptionsAcssDebitObj0MandateOptions(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsAcssDebitObj0MandateOptions(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsAcssDebitObj0MandateOptions handling case conversions
