...
class IdentityVerificationReportListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerIdentityVerificationReportListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for IdentityVerificationReportListCreatedObj0 handling case conversions
