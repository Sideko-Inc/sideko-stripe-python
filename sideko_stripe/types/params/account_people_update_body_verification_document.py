...
class AccountPeopleUpdateBodyVerificationDocument(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyVerificationDocument(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyVerificationDocument handling case conversions
