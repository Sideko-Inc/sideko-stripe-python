...
class TerminalConfigurationCreateBodyTippingObj0Sek(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationCreateBodyTippingObj0Sek(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationCreateBodyTippingObj0Sek handling case conversions
