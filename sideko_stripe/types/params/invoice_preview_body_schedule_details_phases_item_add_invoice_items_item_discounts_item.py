...
class InvoicePreviewBodyScheduleDetailsPhasesItemAddInvoiceItemsItemDiscountsItem(
...
class _SerializerInvoicePreviewBodyScheduleDetailsPhasesItemAddInvoiceItemsItemDiscountsItem(
    pydantic.BaseModel
):
    """
    Serializer for InvoicePreviewBodyScheduleDetailsPhasesItemAddInvoiceItemsItemDiscountsItem handling case conversions
