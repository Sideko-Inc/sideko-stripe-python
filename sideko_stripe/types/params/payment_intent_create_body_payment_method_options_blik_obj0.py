...
class PaymentIntentCreateBodyPaymentMethodOptionsBlikObj0(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsBlikObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsBlikObj0 handling case conversions
