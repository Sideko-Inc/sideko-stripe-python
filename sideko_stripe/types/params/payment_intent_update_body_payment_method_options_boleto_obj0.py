...
class PaymentIntentUpdateBodyPaymentMethodOptionsBoletoObj0(
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodOptionsBoletoObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodOptionsBoletoObj0 handling case conversions
