...
class TreasuryTransactionEntryListEffectiveAtObj0(typing_extensions.TypedDict):
    """
...
class _SerializerTreasuryTransactionEntryListEffectiveAtObj0(pydantic.BaseModel):
    """
    Serializer for TreasuryTransactionEntryListEffectiveAtObj0 handling case conversions
