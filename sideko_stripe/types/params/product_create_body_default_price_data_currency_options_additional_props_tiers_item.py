...
class ProductCreateBodyDefaultPriceDataCurrencyOptionsAdditionalPropsTiersItem(
...
class _SerializerProductCreateBodyDefaultPriceDataCurrencyOptionsAdditionalPropsTiersItem(
    pydantic.BaseModel
):
    """
    Serializer for ProductCreateBodyDefaultPriceDataCurrencyOptionsAdditionalPropsTiersItem handling case conversions
