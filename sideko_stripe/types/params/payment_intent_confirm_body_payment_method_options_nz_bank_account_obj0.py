...
class PaymentIntentConfirmBodyPaymentMethodOptionsNzBankAccountObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodOptionsNzBankAccountObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodOptionsNzBankAccountObj0 handling case conversions
