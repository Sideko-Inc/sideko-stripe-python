...
class TokenCreateBodyPersonVerificationAdditionalDocument(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyPersonVerificationAdditionalDocument(
    pydantic.BaseModel
):
    """
    Serializer for TokenCreateBodyPersonVerificationAdditionalDocument handling case conversions
