...
class TokenCreateBodyAccountIndividualAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTokenCreateBodyAccountIndividualAddress(pydantic.BaseModel):
    """
    Serializer for TokenCreateBodyAccountIndividualAddress handling case conversions
