...
class ChargeCreateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerChargeCreateBodyShippingAddress(pydantic.BaseModel):
    """
    Serializer for ChargeCreateBodyShippingAddress handling case conversions
