...
class TaxSettingUpdateBodyHeadOfficeAddress(typing_extensions.TypedDict):
    """
...
class _SerializerTaxSettingUpdateBodyHeadOfficeAddress(pydantic.BaseModel):
    """
    Serializer for TaxSettingUpdateBodyHeadOfficeAddress handling case conversions
