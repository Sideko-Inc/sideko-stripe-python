...
class PaymentIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerPaymentIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
