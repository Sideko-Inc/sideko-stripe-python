...
class TerminalConfigurationUpdateBodyTippingObj0Jpy(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Jpy(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Jpy handling case conversions
