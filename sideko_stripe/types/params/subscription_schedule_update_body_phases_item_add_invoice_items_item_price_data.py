...
class SubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemPriceData(
...
class _SerializerSubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemPriceData(
    pydantic.BaseModel
):
    """
    Serializer for SubscriptionScheduleUpdateBodyPhasesItemAddInvoiceItemsItemPriceData handling case conversions
