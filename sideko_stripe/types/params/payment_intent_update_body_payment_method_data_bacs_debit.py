...
class PaymentIntentUpdateBodyPaymentMethodDataBacsDebit(typing_extensions.TypedDict):
    """
...
class _SerializerPaymentIntentUpdateBodyPaymentMethodDataBacsDebit(pydantic.BaseModel):
    """
    Serializer for PaymentIntentUpdateBodyPaymentMethodDataBacsDebit handling case conversions
