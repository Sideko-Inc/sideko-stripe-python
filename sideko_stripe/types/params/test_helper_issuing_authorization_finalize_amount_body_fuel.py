...
class TestHelperIssuingAuthorizationFinalizeAmountBodyFuel(typing_extensions.TypedDict):
    """
...
class _SerializerTestHelperIssuingAuthorizationFinalizeAmountBodyFuel(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingAuthorizationFinalizeAmountBodyFuel handling case conversions
