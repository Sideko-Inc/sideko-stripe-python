...
class PaymentIntentCreateBodyPaymentMethodOptionsNaverPayObj0(
...
class _SerializerPaymentIntentCreateBodyPaymentMethodOptionsNaverPayObj0(
    pydantic.BaseModel
):
    """
    Serializer for PaymentIntentCreateBodyPaymentMethodOptionsNaverPayObj0 handling case conversions
