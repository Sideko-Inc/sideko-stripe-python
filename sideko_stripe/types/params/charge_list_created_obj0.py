...
class ChargeListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerChargeListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for ChargeListCreatedObj0 handling case conversions
