...
class AccountPeopleCreateBodyVerificationDocument(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyVerificationDocument(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyVerificationDocument handling case conversions
