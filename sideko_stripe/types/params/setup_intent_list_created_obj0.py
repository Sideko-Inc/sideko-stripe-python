...
class SetupIntentListCreatedObj0(typing_extensions.TypedDict):
    """
...
class _SerializerSetupIntentListCreatedObj0(pydantic.BaseModel):
    """
    Serializer for SetupIntentListCreatedObj0 handling case conversions
