...
class AccountCreateBodyIndividualAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountCreateBodyIndividualAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountCreateBodyIndividualAddressKana handling case conversions
