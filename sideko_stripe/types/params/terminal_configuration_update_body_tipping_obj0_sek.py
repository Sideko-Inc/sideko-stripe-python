...
class TerminalConfigurationUpdateBodyTippingObj0Sek(typing_extensions.TypedDict):
    """
...
class _SerializerTerminalConfigurationUpdateBodyTippingObj0Sek(pydantic.BaseModel):
    """
    Serializer for TerminalConfigurationUpdateBodyTippingObj0Sek handling case conversions
