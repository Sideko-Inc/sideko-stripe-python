...
class ChargeUpdateBodyShippingAddress(typing_extensions.TypedDict):
    """
...
class _SerializerChargeUpdateBodyShippingAddress(pydantic.BaseModel):
    """
    Serializer for ChargeUpdateBodyShippingAddress handling case conversions
