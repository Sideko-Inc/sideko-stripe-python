...
class AccountPeopleUpdateBodyAddress(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleUpdateBodyAddress(pydantic.BaseModel):
    """
    Serializer for AccountPeopleUpdateBodyAddress handling case conversions
