...
class SetupIntentConfirmBodyPaymentMethodOptionsCardThreeDSecure(
...
class _SerializerSetupIntentConfirmBodyPaymentMethodOptionsCardThreeDSecure(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodOptionsCardThreeDSecure handling case conversions
