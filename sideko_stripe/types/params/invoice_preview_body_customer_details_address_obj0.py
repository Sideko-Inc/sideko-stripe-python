...
class InvoicePreviewBodyCustomerDetailsAddressObj0(typing_extensions.TypedDict):
    """
...
class _SerializerInvoicePreviewBodyCustomerDetailsAddressObj0(pydantic.BaseModel):
    """
    Serializer for InvoicePreviewBodyCustomerDetailsAddressObj0 handling case conversions
