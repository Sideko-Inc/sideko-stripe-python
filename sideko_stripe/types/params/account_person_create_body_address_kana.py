...
class AccountPersonCreateBodyAddressKana(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPersonCreateBodyAddressKana(pydantic.BaseModel):
    """
    Serializer for AccountPersonCreateBodyAddressKana handling case conversions
