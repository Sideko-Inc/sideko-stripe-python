...
class SetupIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0(
...
class _SerializerSetupIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0(
    pydantic.BaseModel
):
    """
    Serializer for SetupIntentConfirmBodyPaymentMethodDataBillingDetailsAddressObj0 handling case conversions
