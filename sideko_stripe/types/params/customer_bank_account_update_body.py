...
class CustomerBankAccountUpdateBody(typing_extensions.TypedDict, total=False):
    """
    ...
    metadata: typing_extensions.NotRequired[
        typing.Union[CustomerBankAccountUpdateBodyMetadataObj0, str]
    ]
    """
    ...
    owner: typing_extensions.NotRequired[CustomerBankAccountUpdateBodyOwner]


class _SerializerCustomerBankAccountUpdateBody(pydantic.BaseModel):
    """
    Serializer for CustomerBankAccountUpdateBody handling case conversions
    ...
    metadata: typing.Optional[
        typing.Union[_SerializerCustomerBankAccountUpdateBodyMetadataObj0, str]
    ] = pydantic.Field(alias="metadata", default=None)
    name: typing.Optional[str] = pydantic.Field(alias="name", default=None)
    owner: typing.Optional[_SerializerCustomerBankAccountUpdateBodyOwner] = (
        pydantic.Field(alias="owner", default=None)
    )
