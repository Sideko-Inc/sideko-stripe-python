...
class AccountPeopleCreateBodyRelationship(typing_extensions.TypedDict):
    """
...
class _SerializerAccountPeopleCreateBodyRelationship(pydantic.BaseModel):
    """
    Serializer for AccountPeopleCreateBodyRelationship handling case conversions
