...
class TestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFuel(
...
class _SerializerTestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFuel(
    pydantic.BaseModel
):
    """
    Serializer for TestHelperIssuingTransactionCreateUnlinkedRefundBodyPurchaseDetailsFuel handling case conversions
