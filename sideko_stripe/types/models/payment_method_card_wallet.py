...
class PaymentMethodCardWallet(pydantic.BaseModel):
    ...
    masterpass: typing.Optional[PaymentMethodCardWalletMasterpass] = pydantic.Field(
        alias="masterpass", default=None
    )
    ...
    """
    visa_checkout: typing.Optional[PaymentMethodCardWalletVisaCheckout] = (
