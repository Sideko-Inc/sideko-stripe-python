...
class TreasuryDebitReversal(pydantic.BaseModel):
    """
    ...
    """
    linked_flows: typing.Optional[
        TreasuryReceivedDebitsResourceDebitReversalLinkedFlows
    ] = pydantic.Field(alias="linked_flows", default=None)
    ...
    """
    metadata: TreasuryDebitReversalMetadata = pydantic.Field(
        alias="metadata",
    )
    """
    Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
    """
    network: typing_extensions.Literal["ach", "card"] = pydantic.Field(
        alias="network",
    )
    """
    The rails used to reverse the funds.
    """
    object: typing_extensions.Literal["treasury.debit_reversal"] = pydantic.Field(
        alias="object",
    )
    """
    ...
    """
    status: typing_extensions.Literal["failed", "processing", "succeeded"] = (
        pydantic.Field(
            alias="status",
        )
    )
