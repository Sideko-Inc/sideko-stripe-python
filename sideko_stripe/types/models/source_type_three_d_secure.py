...
class SourceTypeThreeDSecure(pydantic.BaseModel):
    """
    ...
    authenticated: typing.Optional[bool] = pydantic.Field(
        alias="authenticated", default=None
    )
    brand: typing.Optional[str] = pydantic.Field(alias="brand", default=None)
    card: typing.Optional[str] = pydantic.Field(alias="card", default=None)
