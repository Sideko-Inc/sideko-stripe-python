...
class Token(pydantic.BaseModel):
    ...
    bank_account: typing.Optional["BankAccount"] = pydantic.Field(
    ...
    """
    client_ip: typing.Optional[str] = pydantic.Field(alias="client_ip", default=None)
    """
    ...
    """
    object: typing_extensions.Literal["token"] = pydantic.Field(
        alias="object",
    )
    """
